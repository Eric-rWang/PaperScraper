# Venous Oxygen Research Scan — 2026-07-29

**Search window:** Twenty-ninth scan in the series, run **one day** after 2026-07-28. Emphasis on work published or first-surfacing after 07-28, with the standard fallback to the best-available venous-specific work already catalogued. Sources swept today: PubMed/PMC, arXiv (incl. physics.med-ph new listings), bioRxiv/medRxiv, Optica (Biomed. Opt. Express, Optics Letters, Applied Optics), SPIE / *J. Biomed. Opt.*, *Photoacoustics* (ScienceDirect), IEEE Xplore, Nature / *Sci. Rep.* / *Commun. Med.*, Wiley (*Advanced Science*, *J. Biophotonics*), Springer, De Gruyter, MDPI (*Biosensors*, *Sensors*), Frontiers (*Photonics*), *CHEST* / ScienceDirect, ClinicalTrials.gov, ResearchGate, Semantic Scholar, ADS.

**Verification caveat:** As in every prior scan, publisher **full-text** pages — including arxiv.org, pmc.ncbi.nlm.nih.gov, opg.optica.org, advanced.onlinelibrary.wiley.com, sciencedirect.com, nature.com, frontiersin.org and biorxiv/medrxiv — returned **HTTP 403** to direct `WebFetch` in this environment today (the Frontiers editorial below was confirmed by 403 on direct fetch). Every reference below was therefore cross-checked across **at least two independent search-index snippets** (Google Scholar–style result blocks + ADS/ResearchGate/PMC/Optica/De Gruyter listings); per-item notes state what was confirmed and what could not be read directly on a publisher page. One WebSearch query also returned a transient "unavailable" error today (retried via alternate phrasings).

---

## ⚠️ Read this first — day summary

**No new venous-specific *primary* measurement paper today — the eighth consecutive scan cycle with none.** Today's one-day sweep produced **no new SvO₂/ScvO₂ demonstration** and **no new primary item of any kind**. Every measurement result returned today was already catalogued in prior scans.

**One genuinely new-to-corpus item surfaced, but it is not venous-specific:** an *editorial* — "Editorial: Diffusive optics for medical imaging," *Frontiers in Photonics* (2026; DOI 10.3389/fphot.2026.1842429) — a general framing piece on diffuse optics / DOT / SFDI for medical imaging with no venous-SvO₂ primary content. It is logged as a **new standing context lead** (below), **not** ranked in either top-5, because it is tissue-level/general rather than a venous measurement, and its full text could not be read (403).

The venous top-5 sets for both topics are therefore **unchanged from 07-21/07-25/07-28 and carried forward with scores held.** Items re-confirmed still-current by today's sweep (all previously surfaced): the IJV-PA anchor (arXiv:2303.10775); APM+ radial-vein PA oximetry (Sastry et al., *Adv. Sci.* 2026, 10.1002/advs.76366); the Alqahtani jugular optical sensor (De Gruyter CDBME 2024); the IJV DNN + Monte-Carlo work (*Optics Letters* 49(10):2669); the peripheral-venous pulse-modulation method (BioMed Eng OnLine, s12938-017-0351-x); ADS-vis-OCT retinal oximetry (*Commun. Med.* 2023); PACT intravascular oxygenation/flow (PMC11161372); the sulfate blood-phantom metrology paper (arXiv:2512.01458 / *Appl. Opt.* 65(6):1974); Hybrid-Net (arXiv:2512.15394); the distribution-informed data-driven oximetry preprint (arXiv:2403.14863); the transfontanelle-PAI cerebral work; the Gokhale *CHEST* review; and the Zheng dynamic-PA pulsation review. **No new primary venous demonstration.**
...
- **Novelty:** A pulse-oximeter-style optical sensor over the external jugular vein isolates the EJV waveform and returns SvO₂ estimates (~70–75 %, per-subject 71.1/72.2/70.4 %) within the healthy 60–90 % band — still the closest thing to a wearable-form-factor optical SvO₂ device in the literature.
- **Integration insights:** The superficial/low-cost optical analogue of the deep IJV-PA anchor (§2.1); together they bracket the venous-optical problem from the shallow and deep ends. Its open problem — calibration against a blood-gas gold standard — is exactly what the APM+ artery-as-reference approach (§2.2) and MRI reference oximetry (§1.4) aim to close. *Metadata re-cross-confirmed via De Gruyter + ResearchGate (pub. 387159780) again today; full text 403 (flagged).*
...
- **Year / Venue:** 2017 · *BioMedical Engineering OnLine* 16:79 (s12938-017-0351-x); earlier bypass-surgery evaluation lineage (Loughborough, *Physiol. Meas.* 28(8):961, 2007 — IOP 10.1088/0967-3334/28/8/012)
...
- **Integration insights:** The methodological ancestor of the Alqahtani EJV device (§1.1) and the clearest demonstration that **induced venous pulsatility** is a viable route to isolating the venous signal without imaging — a low-cost complement to the deep-vein PA/imaging approaches of Topic 2, and the peripheral analogue of respiration-frequency NIRS venous separation. *Metadata re-cross-confirmed via BMC/Springer + PubMed 17664681 + IOPscience again today; full text reachable in abstract only (403 on some mirrors).*

*(Note: the Mespere VO100 jugular-NIRS ScvO₂ study — *J. Cardiothoracic Vasc. Anesth.*, S1053-0770(23)00782-6 — and the respiration-frequency-selected cerebral-SvO₂ NIRS work (PubMed 24439329) remain in the standing pool as clinical/technique context; they trade in and out of the visible top-5 with §1.5 depending on cycle and are unchanged today.)*
...
*No new venous-specific primary today.* The standing set carried forward with scores held; no new-to-corpus primary item this cycle.
...
- **Relevance:** **7/10** — resolves **retinal-vein** sO₂ at single-vessel scale (venous ~48–72 % vs arterial ~92–95 % in normals; baseline parafoveal venous ≈ 48.4 ± 5.0 vol %, PMC9133487); ~1 % bias vs blood-gas in phantoms, ~2.1 % RMSE vs pulse oximeter in human arteries (n=18).
...
- **Integration insights:** The retina is the one site where per-vessel optical venous saturation is routinely achievable; its adaptive spectral-contaminant-removal is exactly the class of correction a deep-vein PA/optical system needs to reach absolute SvO₂. *Cross-confirmed via Nature + PMC10126115 + PMC9133487 again today; full text 403 (flagged).*
...
- **NEW today — Editorial: "Diffusive optics for medical imaging," *Frontiers in Photonics* (2026; DOI 10.3389/fphot.2026.1842429).** A general framing editorial on diffuse optics — DOT, SFDI, high-speed diffuse optical imaging — for medical applications. **Not venous-specific and not a primary measurement**; logged as a new context lead only. Relevant to Topic 2 as a survey of the DOT/SFDI modalities that, at best, resolve *tissue-level* StO₂ (SFDI can discriminate venous-vs-arterial occlusion by StO₂ dynamics, but this is not vessel-resolved SvO₂). *Metadata confirmed via Frontiers listing snippet; full text returned 403 on direct fetch today (flagged — title/venue verified, author list not directly readable).*
...
- **Hybrid-Net — Deep-Learning-Driven Quantitative Spectroscopic PA Imaging for Segmentation and sO₂ Estimation** (arXiv:2512.15394, Dec 2025) — joint vessel segmentation + sO₂ without explicit fluence estimation (segmentation ≥0.978 sim / 0.998 exp; sO₂ MSE ≤0.048 sim / 0.003 exp); general PA-oximetry method, not venous-specific. Standing lead, re-confirmed today.
- **Motion rejection and spectral unmixing for accurate in-vivo sO₂ using MSOT** (arXiv:2309.08223) — motion-robust optoacoustic sO₂; general, not venous-specific. Standing technique lead, re-confirmed present today.
...
- **ClinicalTrials.gov NCT06632197** — capnodynamic non-invasive mixed-venous SvO₂ in adults — non-optical clinical-reference lead. **NCT04778150 / NCT04624009** — NIRS SjvO₂ (liver transplant / critically ill) — clinical NIRS-venous leads.

---

## Cross-topic synthesis

**1. The field has not moved in eight cycles, and that is itself the finding.** Eight consecutive scans with zero new primary non-invasive-venous-optical measurement papers is not a gap in the search — it is the publication rate. Today's sweep re-confirmed every anchor is still current and surfaced exactly one new-to-corpus item — a *general diffusive-optics editorial* with no venous-primary content. The honest read for a reader tracking this space: watch the **~5 anchor programs**, not the daily/weekly literature — the true-venous signal is quarterly at best.
...
**5. Venous sO₂ is a field, not a scalar.** The PACT flow/oxygenation-heterogeneity work (§2.4) plus the dynamic-PA pulsation review (standing) reframe the target as a *spatiotemporal* quantity — saturation × flow = oxygen flux — which is ultimately the clinically meaningful variable and the direction the two anchor programs will need to grow toward. Separating pulsatile-arterial from respiration-modulated-venous components (dynamic PA; respiration-frequency NIRS; peripheral pulse-modulation §1.5) is the shared signal-processing key across every modality here. Today's new Frontiers DOT/SFDI editorial is a reminder that the diffuse-optics family, by contrast, still tops out at *tissue-level* StO₂ and does not yet reach vessel-resolved venous SvO₂.

---

*Scan complete. No new primary venous-specific optical measurement identified for 2026-07-29 (eighth consecutive null cycle). One new-to-corpus item logged — a general Frontiers diffusive-optics editorial, non-venous, not ranked. Top-5 sets carried forward unchanged with scores held; all metadata re-cross-confirmed against ≥2 independent index snippets today, publisher full-text 403 throughout (flagged per item).*
