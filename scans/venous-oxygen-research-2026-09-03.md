# Daily Venous-Oxygen Research Scan — 2026-09-03

## ⚠️ Read this first — day summary

- **Scan cadence:** 47th scan in the series (immediately prior run 2026-09-02). Emphasis on work published or first-surfacing after 09-02.
- **Verification caveat (today):** `WebSearch` was available and productive; `WebFetch` to scholarly hosts remains **egress-blocked by the environment's network policy** — a direct `WebFetch` of `arxiv.org/list/physics.med-ph/2026-08` returned `EGRESS_BLOCKED`, matching the pattern from 08-29 → 09-02. Every item below was therefore **cross-checked across ≥2 independent search-index snippets** rather than read on the publisher page. Items whose full metadata could not be page-verified are flagged **⚠ search-derived**.
- **No new venous-specific optical measurement paper first-surfaced today.** Targeted sweeps across the in-scope modalities — SvO₂/ScvO₂ optical, jugular PA/NIRS, peripheral/PPG venous oximetry, vis-OCT venular oximetry, hyperspectral fundus, DOS/SFDI/FD-DOS venous-occlusion, ScvO₂ optoacoustic, ULM+PA co-registration, learned-spectral-decoloring / PINN spectral unmixing, and recent arXiv physics.med-ph — returned **only papers already catalogued** in prior dated files. This is a genuine low-publication-volume field, exactly as the last several scans reported — **not** a search gap. I am **not** padding with arterial-only SpO₂ work.
- **Candidates checked and confirmed already-in-corpus this run:** jugular optical sensing (De Gruyter CDBME 10.1515/cdbme-2024-2072), IJV DNN/Monte-Carlo (Opt. Lett. 49(10):2669), peripheral pulse-modulation venous oximetry (BMEO s12938-017-0351-x), the cardiac-bypass venous-oximetry method (IOP Physiol. Meas. 28(8), 10.1088/0967-3334/28/8/012), the external-stimulation venous SvO₂ method (BMEO s12938-016-0208-8), the e-tattoo (IEEE 10340010), Mespere VO100 (S1053077023007826), Sastry APM+ (Adv. Sci. 10.1002/advs.76366), Nakamura IJV PAT arXiv 2303.10775, Ni PACT flow-visualisation via oxygenation heterogeneity (PMC11161372), ADS-vis-OCT (PMC10126115), Tran hyperspectral retinal (PMC12997856), Davenet/Gateau ULM+PA (arXiv:2608.19823), 3D-PAULM (bioRxiv 10.64898/2026.04.30.722008), Hybrid-Net (arXiv:2512.15394), Distribution-informed data-driven PA oximetry (arXiv:2403.14863), PINN spectral unmixing (arXiv:2602.16357), the WorldSci PACT-oximetry principles/progress review (S1793545826300065), NIR-II PA sO₂ (bioRxiv 2024.08.08.607178 / PMC11833698), FD-NIRS ASIC (PMC12904531), and the Apple PPGen/HAI lead (arXiv:2510.02073 · IOP 10.1088/3049-477X/ae4a96) all re-surfaced but are already logged.
- **No new true-venous lead emerged.** The strongest true-venous entries recur below, all marked *previously surfaced*, with honest relevance scores. The most recent genuinely-new intravascular-venular result in the corpus remains the **08-13 hyperspectral retinal system** (Tran et al.); the most recent new imaging-platform lead remains the **08-25 Davenet/Gateau ULM+PA** preprint.
...
- **Authors:** Alqahtani et al. (author list fetch-verified 06-10; re-confirmed via De Gruyter + ResearchGate index snippets today).
...
- **Integration insights:** The cleanest "wearable optical → true venous sO₂" proof point; reference design for a low-cost venous analogue to SpO₂. Complements the deep-tissue PA and imaging methods in Topic 2 (which localize the vessel but need bulkier hardware).
...
- **Year / Venue:** 2026 · *Journal of Biomedical Optics* **31**(3):036006 (2026 Mar 1); DOI 10.1117/1.JBO.31.3.036006; PMC12997856; PMID 41858558. ⚠ SPIE/PMC egress-blocked today; metadata re-confirmed on the UT Southwestern Elsevier Pure snippet + PMC listing today (accepted Feb 2026, published Mar 2026).
...
- **PINN Spectral Unmixing — *Optical Inversion and Spectral Unmixing of Spectroscopic Photoacoustic Images with Physics-Informed Neural Networks*** (arXiv:2602.16357). *Standing technique lead — re-surfaced today.* Physics-informed neural nets embed the light-transport forward operator into the sO₂ inversion; the same fluence-correction problem APM+ (§2.2) tackles empirically, from a differentiable-physics angle. Complementary to Hybrid-Net's segmentation-only route.
- **Distribution-informed and Wavelength-Flexible Data-Driven Photoacoustic Oximetry** (arXiv:2403.14863). *Standing technique lead — re-surfaced today.* A wavelength-flexible learned-decoloring approach that generalizes across illumination sets; the training-distribution framing is a bridge between multiple-illumination learned decoloring (Kirchner et al. 2021) and clinical PA-oximetry generalization.
- **Quantitative Oximetry with Photoacoustic Computed Tomography: Principles, Progress, and Prospects** (*J. Innov. Opt. Health Sci.* 2026, 10.1142/S1793545826300065). *Standing review — re-surfaced today across topic 2 searches.* Positions APM+, learned-decoloring, and multimodality-fusion methods against the spectral-coloring problem; useful as an authoritative 2026 review anchor for the topic.
...
2. **Today's re-surfaced hits were all already-catalogued.** Searches returned the jugular optical sensor, the peripheral-venous PPG lineage (including both older peripheral-venous method papers, IOP 10.1088/0967-3334/28/8/012 and BMEO s12938-016-0208-8), the e-tattoo, the ULM+PA / 3D-PAULM pair, APM+, the hyperspectral fundus system, plus the PA methodology cluster (Hybrid-Net, PINN spectral unmixing, distribution-informed data-driven decoloring, the 2026 PACT-oximetry review) — every one already in the corpus. The PPG/venous-modulation lineage remains the conceptual root of Topic-1, now with Apple's PPGen/HAI as its physics-plus-ML modern successor.

3. **Where 2026 momentum actually sits: oxygenation + flow co-registration, and the fluence-correction cluster.** Two clear 2026 trends now cover Topic-2 papers together: (a) pairing **photoacoustic sO₂** with **ULM/Doppler perfusion** on a shared array (Davenet/Gateau ULM+PA platform + 3D-PAULM sibling + Davenet/Billon sulfate phantoms), and (b) attacking spectral coloring / unknown fluence directly — APM+'s arterial in-situ reference, PINN-based physics-informed inversion, learned decoloring, and the WorldSci 2026 review that positions all of it. For *venous* monitoring the hardest unsolved problem is not measuring sO₂ but **knowing which vessel is the vein and correcting for local fluence**; these two lines answer that jointly.
...
5. **The near-term opportunity is porting, not discovering.** With Topic-1 clinical targets (IJV, radial/peripheral veins) stable and Topic-2 techniques advancing, the highest-leverage move is transferring Topic-2 advances — fluence correction, adaptive spectral decoloring, oxygenation–flow co-registration, sulfate-phantom metrology, PINN-based inversion — and PPGen-style compartment-resolved forward modeling onto the Topic-1 venous targets.
