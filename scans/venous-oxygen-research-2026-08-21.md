# Venous Oxygen Research Scan — 2026-08-21

**Search window:** Thirty-ninth scan in the series, run **one day** after 2026-08-20. Emphasis on work published or first-surfacing after 08-20, with the standard fallback to the best-available venous-specific work already catalogued. Sources swept today: PubMed/PMC, arXiv (physics.med-ph / eess.IV new-listing sweep), bioRxiv/medRxiv, Optica (Biomed. Opt. Express, Optics Letters, Applied Optics), SPIE / *J. Biomed. Opt.*, *Photoacoustics* (ScienceDirect), Springer, Wiley (*Advanced Science*, *J. Biophotonics*), De Gruyter, MDPI (*Sensors/Biosensors*), IEEE Xplore, Nature / *Sci. Rep.* / *Commun. Med.*, American Physiological Society journals, ClinicalTrials.gov, plus Semantic Scholar / Google-Scholar-style index snippets and ResearchGate.

**Verification caveat:** Publisher **full-text** pages and several databases remain unreachable for direct `WebFetch` in this environment. The usual publisher hosts (link.springer.com, opg.optica.org, sciencedirect.com, wiley.com, spiedigitallibrary.org, pmc.ncbi.nlm.nih.gov, journals.physiology.org) and research portals (portal.research.lu.se) return **HTTP 403 / EGRESS_BLOCKED** to direct fetch; arxiv.org / pubmed.ncbi.nlm.nih.gov are egress-blocked on direct new-listing fetch. The blocks are source-/policy-side, not relay failures. Every reference below was therefore cross-checked across **≥2 independent search-index snippets**; per-item notes state what was confirmed and what could not be read directly on a publisher page.

---

## ⚠️ Read this first — day summary

**No new venous-specific optical measurement paper first-surfaced in the one-day 08-20 → 08-21 window.** Repeated targeted sweeps (SvO₂ / ScvO₂ optical, jugular PA/NIRS, deep-vein PA, vis-OCT venular oximetry, hyperspectral fundus, DOS/DOI respiration-modulation, SFDI) returned only the **standing corpus** plus **one method paper new to this corpus but not venous-specific** — Khodaverdi et al., *Biomed. Opt. Express* 16(6):2217–2231 (2025), a human in-vivo photoacoustic **spectral-coloring compensation** study (finger, tissue-level). It is logged as a new **standing-context lead** under Topic 2, not a top-5 venous item.
...
**No new venous-specific systemic (SvO₂/ScvO₂) measurement paper today — the eighteenth consecutive scan cycle with none.** All standing Topic-1 anchors and the deep-vein PA anchors are unchanged and carried forward with scores held.
...
**Topic-1 clinical-trial watch (context, not a paper):** ClinicalTrials.gov **NCT06511999** — *Feasibility and Validation of Continuous Measurement of Jugular Venous Oxygen Saturation (SjO₂) in Comatose Patients After Cardiac Arrest* (status verified 2026-06, RECRUITING). Logged for situational awareness only; the SjO₂ measurement is **catheter-based (invasive)**, so it is **out of scope** for non-invasive optical venous oximetry — noted here so future scans do not re-surface it as an optical result.
...
*No new item in the ranked set today.* Measurement anchors carried forward with scores held; the 08-13 hyperspectral retinal system (§2.5) remains the most recent genuinely-new entry. One new-to-corpus **method lead** (Khodaverdi et al., PA spectral-coloring compensation) is logged in the standing-context section below.
...
- **Integration insight:** The most recent (2026) primary PA venous-oximetry advance in the corpus; its fluence-correction strategy is the deep-vein counterpart to the retinal per-vessel corrections §2.4/§2.5 catalogue and to the Hybrid-Net / PINN spectral-unmixing leads. It now has a direct methodological sibling in the new Khodaverdi et al. compensation lead (below).
...
**Topic-2 note:** the anchors most on-target for *systemic deep-vein* venous oximetry (§2.1 IJV-PA, §2.2 APM+ radial vein) are unchanged; no new item this cycle strengthens either the systemic deep-vein or the retinal per-vessel sub-cluster. The one genuinely new-to-corpus find (Khodaverdi et al., below) is a *tissue-level* human-finger PA-decoloring method, catalogued as a lead rather than a ranked venous result.

---

## Standing context leads (not ranked in the top-5)

- **⭐ NEW TO CORPUS — Two photoacoustic spectral-coloring compensation techniques adapted to the context of human in-vivo oxygenation measurements** — Khodaverdi A., Jayet B., Erlöv T., Albinsson J., Merdasa A., Gustafsson N., Sheikh R., Malmsjö M., Andersson-Engels S., Cinthio M. (Lund University / Lund Clinical Center for Spectral and Acoustic Imaging) · *Biomedical Optics Express* **16**(6):2217–2231 (**2025**). Compares and adapts two previously-proposed **spectral-coloring compensation** methods to real human in-vivo PA data, evaluated on a tissue-mimicking phantom (relative mean-square error reduced from ~65 % to ~1.2 % at the highest concentration) and applied to **in-vivo human finger** sO₂ maps versus linear unmixing. **Tissue-level, NOT venous-specific** — it images finger tissue oxygenation, not a named vein — but it is a direct **method sibling to the deep-vein decoloring problem (§2.2 APM+)** and to the learned-decoloring / PINN-unmixing leads: it is one of the few papers to test fluence/spectral-coloring correction on *actual human in-vivo* PA data rather than simulation or phantom alone, which is exactly the regime a deep-vein optical-venous readout must survive. Logged as a method lead. *Metadata (authors, venue, volume/issue/pages) cross-confirmed across FUJIFILM VisualSonics publication listing + Lund University research portal + ResearchGate; DOI numeral not directly readable (portal.research.lu.se and opg.optica.org egress-blocked) — treat DOI as unverified, cite via the BOE 16(6):2217 locator.*
- **Near-infrared spectroscopy demonstrates preserved and reproducible resting skeletal muscle oxygenation across anatomical sites in stable heart failure** — *Am. J. Physiol. Heart Circ. Physiol.* (2026) · DOI 10.1152/ajpheart.00398.2026. **Tissue-level (StO₂), NOT venous.** Continuous-wave NIRS reproducibility study of resting skeletal-muscle oxygenation across anatomical sites in stable heart-failure patients; the StO₂ signal is a mixed arterial+venous microvascular quantity, not an intravascular SvO₂. Value to the corpus is as a 2026 StO₂-reproducibility baseline for the wearable/tissue-oximetry device class (§1.3/§1.4). *journals.physiology.org egress-blocked; title/venue/DOI snippet-verified only — reported-not-verified.*
...
- **Diffuse Optical Spectroscopy and Imaging X (SPIE Proc. Vol. 13935, 2025)** — proceedings-level DOS/DOI collection; the current SPIE venue for respiration-modulation venous DOS methods. Not a single venous-specific result, but the standing conference home for the strategy-2 (signal-separation) DOS lineage (spiroximetry, cerebral-venous DOS). Listing-verified only.
- **Integrated spectral and depth compensation for sO₂ and total-hemoglobin estimation in PAT for ovarian-lesion diagnosis (ISDC)** — *Biomed. Opt. Express*-lineage, 2026 · PMC12869027. Combines spectral + depth fluence compensation for deep-tissue PAT sO₂; **not venous-specific** (arterial+venous tissue, ovarian). Method lead for the deep-vein decoloring problem (§2.2), and a close cousin of the new Khodaverdi compensation lead. Snippet-verified only.
...
- **Deep Learning-Driven Quantitative Spectroscopic PA Imaging for Segmentation and Oxygen Saturation Estimation (Hybrid-Net)** — arXiv:2512.15394 (Dec 2025). Joint vessel segmentation + sO₂ estimation without explicit fluence estimation; trained on Monte-Carlo-simulated sPA (700/850 nm) and retrained on phantoms. Not venous-specific but directly relevant to the deep-vein PA decoloring problem (§2.2). arxiv.org egress-blocked today; re-verified via ADS record 2025arXiv251215394S + index snippet.
...
- **Learned Spectral Decoloring enables Photoacoustic Oximetry** — *Scientific Reports* 11:6565 (2021) · DOI 10.1038/s41598-021-83405-8 · arXiv:1902.05839. Foundational learned-decoloring method (train on Monte-Carlo-simulated colored spectra); conceptual root of the data-driven-unmixing leads above. Not venous-specific.
- **Improved Spectral Inversion of Blood Oxygenation due to Reduced Tissue Scattering: Towards NIR-II Photoacoustic Imaging** — bioRxiv 2024.08.08.607178. Using NIR-II wavelengths cut blood sO₂ estimation error ~50 % vs conventional NIR-I, including at larger depths. Wavelength-selection lead for the deep-vein decoloring problem (§2.2); not venous-specific.
...
- **Noninvasive tracking of mixed venous oxygen saturation via NIRS cerebral oximetry** — *Scientific Reports* 13, s41598-023-49078-1 (2023). Retrospective study relating cerebral-oximetry NIRS to mixed venous saturation (SvO₂); a tissue-NIRS surrogate for systemic venous, not a direct intravascular readout. Context lead for the jugular/cerebral-NIRS class (§1.5). Snippet-verified.
...
Today's one-day sweep (08-20 → 08-21) produced **no new intravascular venous optical result** for either topic, and **no item genuinely new to the ranked corpus**. The only genuinely new-to-corpus find is a **tissue-level** human-finger PA method — Khodaverdi et al.'s spectral-coloring compensation study (BOE 2025) — logged as a method lead, not a venous result. **No new systemic SvO₂/ScvO₂ measurement paper appeared — the eighteenth consecutive dry cycle** for true central/peripheral venous work once arterial-only and tissue-level items are excluded. The most recent genuinely-new *venous* result in the corpus remains the 08-13 Tran et al. hyperspectral retinal imager (§2.5), in the **retinal per-vessel venular** sub-cluster.
...
3. **Physics- and data-based decoloring / per-vessel correction** before unmixing (deep-tissue PA fluence correction §2.2, per-vessel spectral cleanup in vis-OCT §2.4, intravascular PACT §2.3, hyperspectral spatial–spectral fusion §2.5, plus the Hybrid-Net / SPOI-AE / learned-spectral-decoloring / distribution-informed / ISDC / NIR-II unmixing leads and the sulfate- and anthropomorphic-phantom metrology). **Today's Khodaverdi lead lands squarely in this strategy-3 bucket** and is notable for testing decoloring on *actual human in-vivo* PA data — the regime a deep-vein optical-venous readout must ultimately survive — even though its target is finger tissue, not a vein.
...
*Scan generated 2026-08-21 (UTC). Metadata cross-checked across ≥2 search-index snippets per item; pubmed.ncbi.nlm.nih.gov, journals.physiology.org, www.spiedigitallibrary.org, portal.research.lu.se, and arxiv.org were egress-blocked, and publisher full-text pages returned HTTP 403 to direct fetch in this environment (source-/policy-side; agent proxy healthy), so items flagged "full text not read" / "snippet-verified" are abstract- or snippet-level and flagged unverified fields are noted inline.*
