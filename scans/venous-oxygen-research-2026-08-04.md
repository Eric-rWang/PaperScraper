# Venous Oxygen Research Scan — 2026-08-04

**Search window:** Thirty-first scan in the series, run **one day** after 2026-08-03. Emphasis on work published or first-surfacing after 08-03, with the standard fallback to the best-available venous-specific work already catalogued. Sources swept today: PubMed/PMC, arXiv (incl. physics.med-ph new-listing sweep), bioRxiv/medRxiv, Optica (Biomed. Opt. Express, Optics Letters, Applied Optics), SPIE / *J. Biomed. Opt.*, *Photoacoustics* (ScienceDirect), World Scientific (*J. Innov. Opt. Health Sci.*), IEEE Xplore, Nature / *Sci. Rep.* / *Commun. Med.*, Wiley (*Advanced Science*, *J. Biophotonics*), Springer, De Gruyter, MDPI, *CHEST* / ScienceDirect, ClinicalTrials.gov, USPTO, ResearchGate, Semantic Scholar, ADS.

**Verification caveat:** As in every prior scan, publisher **full-text** pages — including degruyterbrill.com, worldscientific.com, spiedigitallibrary.org, pmc.ncbi.nlm.nih.gov, arxiv.org (incl. `/abs/` and `/list/` and ADS mirrors), opg.optica.org, advanced.onlinelibrary.wiley.com, sciencedirect.com, iopscience.iop.org and the Nature domains — returned **HTTP 403** to direct `WebFetch` in this environment today. Every reference below was therefore cross-checked across **at least two independent search-index snippets** (Google Scholar–style result blocks + De Gruyter / World Scientific / SPIE Digital Library / PMC / ADS / ResearchGate / Optica / ClinicalTrials.gov / USPTO listings); per-item notes state what was confirmed and what could not be read directly on a publisher page.

---

## ⚠️ Read this first — day summary

**No new venous-specific *primary* measurement paper today — the tenth consecutive scan cycle with none.** Consistent with the series' standing observation, truly novel non-invasive **venous**-optical work publishes at very low volume. Today's one-day sweep across all listed sources returned **no new SvO₂/ScvO₂/peripheral-venous demonstration and no new venous *measurement* on the imaging side either.** The Topic-1 (true SvO₂) top-5 and the Topic-2 top-5 are unchanged and carried forward with scores held.

**Nothing new-to-corpus surfaced today** — not even on the review/IP layer that moved on 08-03. Every item returned by today's queries maps to a paper already catalogued: the Alqahtani EJV optical device (De Gruyter CDBME-2024-2072), the IJV DNN + Monte-Carlo work (*Optics Letters* 49(10):2669), APM+ radial-vein PA oximetry (Sastry/Olick-Gibson et al., *Adv. Sci.* 2026, 10.1002/advs.76366), the PACT intravascular oxygenation/flow paper (PMC11161372), the ADS-vis-OCT retinal oximetry paper (*Commun. Med.* 2023), the Tran/Fei hyperspectral retinal HSI system (*J. Biomed. Opt.* 31(3):036006), the JIOHS quantitative-PACT-oximetry review (10.1142/S1793545826300065), the Gokhale *CHEST* review, the peripheral pulse-modulation venous oximetry lineage (BMC *BioMed Eng OnLine* 2017; Loughborough *Physiol. Meas.* 2007), the "New Method for Noninvasive Venous Blood Oxygen Detection" (BMC 2016), the Mespere VO100 jugular-NIRS ScvO₂ study, the respiration-frequency cerebral-SvO₂ NIRS work (PMID 24439329), the SFDI-vs-TCOM-vs-PPG tissue-oxygenation comparison (*Sci. Rep.* 2025, s41598-025-15767-2), and the clinical-trial leads (NCT04778150 / NCT04624009 / NCT06632197 / NCT02476630). **No new primary venous demonstration; no new standing lead.**
...
- **Year / Venue:** 2017 · *BioMedical Engineering OnLine* 16:79 (s12938-017-0351-x); earlier bypass-surgery evaluation lineage (Loughborough, *Physiol. Meas.* 28(8), 2007, 10.1088/0967-3334/28/8/012)
...
*(Note: the Mespere VO100 jugular-NIRS ScvO₂ study — *J. Cardiothoracic Vasc. Anesth.*, S1053-0770(23)00782-6, PMID 37827917 — the "New Method for Noninvasive Venous Blood Oxygen Detection" light-absorption/external-stimulation method — *BioMed Eng OnLine* 2016, s12938-016-0208-8, PMC4952148 — and the respiration-frequency-selected cerebral-SvO₂ NIRS work — PMC4126245 / PMID 24439329 — remain in the standing pool as clinical/technique context; they trade in and out of the visible top-5 with §1.5 depending on cycle and are unchanged today.)*
...
*No new top-5 items this cycle.* The standing top-5 is carried forward with scores held. No new venous *measurement* and no new-to-corpus review/IP lead surfaced today.
...
- **Integration insights:** The deep-vein anchor that everything else is measured against; APM+ (§2.2), APRECOT and the DPF model (standing leads) are all, in different ways, attempts to make this class of measurement quantitative and fluence-robust without an ultrasound co-registration crutch. Now also the centerpiece example in the JIOHS quantitative-PACT-oximetry review (standing lead) and the Gokhale *CHEST* clinical review (standing lead). *Metadata cross-confirmed via arXiv + ADS + SPIE listing again today; full text 403 (flagged).*
...
- **Integration insights:** The clearest worked example of internal-reference calibration on the optical side and the corpus's second in-vivo human non-invasive optical venous result after the IJV-PA anchor (§2.1). The fluence-calibration problem it solves locally is exactly the "spectral coloring" bottleneck the JIOHS review (standing lead) frames as *the* central obstacle of quantitative PACT oximetry, and the one APRECOT attacks globally with anatomical priors. *Metadata cross-confirmed via Wiley + arXiv oximetry snippets again today; full text 403 (flagged).*
...
- **Integration insights:** The depth-resolved, interferometric counterpart to the snapshot-HSI system (§2.3): both deliver retinal per-vessel A/V sO₂ but trade off differently (vis-OCT = depth-resolved, single-vessel accuracy; HSI = snapshot, wide-field, pansharpened). Its adaptive spectral-contaminant-removal is exactly the class of correction the JIOHS review (standing lead) surveys for deep-tissue PACT. *Cross-confirmed via Nature + PMC10126115 again today; full text 403 (flagged).*
...
- **"Comparative Assessment of Healthy Tissue Oxygenation Using Near-Infrared Imaging, Transcutaneous Oxygen Measurement, and Plethysmography," *Scientific Reports* 2025 (s41598-025-15767-2).** 20-subject comparison of SFDI, TCOM, wearable PPG and pulse oximetry; **SFDI uniquely detected significant StO₂ differences**, evidence for SFDI's sensitivity to tissue-level oxygenation heterogeneity. Tissue-level (StO₂), not venous — standing SFDI-context lead. *Cross-confirmed via Nature listing + search snippet; full text 403 (flagged).*
- **"Advancements in photoacoustic detection techniques for biomedical imaging," *npj Acoustics*, 2025** (s44384-025-00005-w). General review of PA detection hardware (incl. non-contact/remote-sensing detection à la PARS); breadth context for the detection side of deep-vein PA oximetry, not venous-specific. Standing lead.
...
- **ClinicalTrials.gov NCT06632197** — capnodynamic non-invasive mixed-venous SvO₂ in adults (non-optical clinical-reference lead). **NCT04778150 / NCT04624009** — NIRS SjvO₂ in liver-transplant / critically-ill patients (clinical NIRS-venous leads). **NCT02476630** — thenar StO₂ as a non-invasive surrogate for ScvO₂ (tissue-level clinical lead).

---

## Cross-topic synthesis

**1. Tenth consecutive cycle with no new venous *primary* measurement — and a fully static day even on the review/IP layer.** Today's one-day sweep produced **no new systemic-SvO₂/ScvO₂ demonstration** (Topic 1 unchanged), **no new venous *measurement*** on the imaging side (Topic-2 top-5 unchanged, scores held), and — unlike 08-03, which added the JIOHS review and the NI-PARS patent — **no new standing lead either**. Every query result mapped to a paper already catalogued. This is the quietest possible outcome and is fully consistent with the standing read that truly novel non-invasive venous-optical *measurement* publishes quarterly at best.

**2. The two human demonstrations that bracket the *systemic* problem are still the whole field, and both are photoacoustic.** The IJV-PA anchor (§2.1, deep central vein, US-co-registered) and APM+ (§2.2, peripheral radial vein, artery-calibrated) remain the only two in-vivo human non-invasive *optical* venous-sO₂ results in the corpus, converging on ~72 % by opposite routes. Everything else true-venous is non-optical (MRI iSvO₂ §1.4, SSL intra-cardiac MR §1.3) or shallow/peripheral device work (Alqahtani EJV §1.1, pulse-modulation §1.5, the 2016 light-absorption method). The *systemic* optical-venous field still rests on two papers.

**3. The binding constraints are unchanged: fluence/spectral-coloring, uncertainty quantification, and labelled in-vivo ground truth.** The 08-03 JIOHS review remains the field's first dedicated map of the fluence bottleneck that separates §2.1/§2.2 from a clinical device, and it is the umbrella under which ISDC, APRECOT, Hybrid-Net, the DPF model and the diffusion-DOT lead all sit. Calibrated error bars (UQ) — now shipped on the MRI side (§1.3) and the DOT side (score-based diffusion, standing lead) — are still largely absent on the PA anchors. And labelled in-vivo SvO₂ ground truth remains the scarcest resource, which is why the MRI/ML entries matter as transferable methodology and validation targets and the sulfate/anthropomorphic phantoms matter as the ground-truth substitute.

**4. Open gaps carried forward, all still open.** (a) No continuous, calibrated, wearable optical SvO₂ device validated against blood-gas with published limits-of-agreement; (b) no quantitative deep-venous PA sO₂ with an in-situ fluence reference across multiple deep sites and the full venous 40–75 % range; (c) no non-invasive optical/PA SvO₂ method benchmarked head-to-head against reference CMR oximetry. Today closed none of these and added nothing new to the terrain-mapping layer either.

---

*Scan generated 2026-08-04 (UTC). No new venous-specific **primary** SvO₂/ScvO₂ measurement (tenth consecutive cycle); Topic-1 and Topic-2 top-5 lists carried forward with scores held. **No new-to-corpus item on any layer today** — no new measurement, no new review, no new IP lead; every query result mapped to a previously-catalogued paper. Publisher full-text access was 403-blocked throughout this environment; every reference was cross-checked across ≥2 independent search-index snippets, with per-item verification notes and flags above.*
