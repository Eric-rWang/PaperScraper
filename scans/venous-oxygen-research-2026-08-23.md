# Venous Oxygen Research Scan — 2026-08-23

**Search window:** Fortieth scan in the series, run **two days** after 2026-08-21. Emphasis on work published or first-surfacing after 08-21, with the standard fallback to the best-available venous-specific work already catalogued. Sources swept today: PubMed/PMC, arXiv (physics.med-ph / eess.IV new-listing sweep), bioRxiv/medRxiv, Optica (Biomed. Opt. Express, Optics Letters, Applied Optics), SPIE / *J. Biomed. Opt.*, *Photoacoustics* (ScienceDirect), Springer, Wiley (*Advanced Science*, *J. Biophotonics*), De Gruyter, MDPI (*Sensors/Biosensors*), IEEE Xplore, Nature / *Sci. Rep.* / *Commun. Med.*, Frontiers (*Photonics*), American Physiological Society journals, ClinicalTrials.gov, plus Semantic Scholar / Google-Scholar-style index snippets and ResearchGate.

**Verification caveat:** Publisher **full-text** pages and several databases remain unreachable for direct `WebFetch` in this environment. The usual publisher hosts (link.springer.com, opg.optica.org, sciencedirect.com, wiley.com, spiedigitallibrary.org, pmc.ncbi.nlm.nih.gov, journals.physiology.org, frontiersin.org) return **HTTP 403 / EGRESS_BLOCKED** to direct fetch; arxiv.org / pubmed.ncbi.nlm.nih.gov are egress-blocked on direct new-listing fetch. The blocks are source-/policy-side, not relay failures. Every reference below was therefore cross-checked across **≥2 independent search-index snippets**; per-item notes state what was confirmed and what could not be read directly on a publisher page.

---

## ⚠️ Read this first — day summary

**No new venous-specific optical measurement paper first-surfaced in the two-day 08-21 → 08-23 window.** Repeated targeted sweeps (SvO₂ / ScvO₂ optical, jugular PA/NIRS, deep-vein PA, vis-OCT venular oximetry, hyperspectral fundus, forearm/saphenous-vein PA, DOS/DOI respiration-modulation, SFDI) returned only the **standing corpus**. Every ranked-item hit today mapped to a paper already catalogued in a prior dated file.
...
**No new venous-specific systemic (SvO₂/ScvO₂) measurement paper today — the twentieth consecutive scan cycle with none.** All standing Topic-1 anchors and the deep-vein PA anchors are unchanged and carried forward with scores held.

**One genuinely new-to-corpus 2026 item was found, but it is not venous-specific:** a *Frontiers in Photonics* editorial, *"Diffusive optics for medical imaging"* (2026), logged as a standing-context/review lead under Topic 2, not a ranked venous result.
...
**Topic-1 clinical-trial watch (context, not a paper):** ClinicalTrials.gov **NCT06511999** — *Feasibility and Validation of Continuous Measurement of Jugular Venous Oxygen Saturation (SjO₂) in Comatose Patients After Cardiac Arrest* (RECRUITING). Additionally noted this cycle: **NCT06632197** — *Non-invasive Monitoring of Mixed Venous Oxygen Saturation Using the Capnodynamic Method in Adults*. Both logged for situational awareness only; NCT06511999's SjO₂ is **catheter-based (invasive)** and NCT06632197 is a **capnodynamic (CO₂-rebreathing), not optical** method — both **out of scope** for non-invasive optical venous oximetry, noted here so future scans do not re-surface them as optical results.
...
*No new item in the ranked set today.* Measurement anchors carried forward with scores held; the 08-13 hyperspectral retinal system (§2.5) remains the most recent genuinely-new entry. One genuinely new-to-corpus **review/editorial lead** (Frontiers *Diffusive optics for medical imaging*, 2026) is logged in the standing-context section below.
...
- **⭐ NEW TO CORPUS — Editorial: Diffusive optics for medical imaging** — *Frontiers in Photonics* (2026) · DOI 10.3389/fphot.2026.1842429. A 2026 editorial framing the current state of diffuse-optics medical imaging — diffuse optical tomography (DOT), spatial frequency-domain imaging (SFDI), time-resolved spectroscopy, and diffuse correlation spectroscopy (DCS) — and their extraction of chromophore concentrations (HbO₂/Hb) and physiological parameters (tissue oxygenation, blood volume/flow, metabolism). **Review/editorial, NOT a venous-specific primary result and NOT intravascular SvO₂** — it addresses tissue-level diffuse-optics broadly. Logged as the current review-level umbrella for the strategy-2 (signal-separation) DOS/DOI and strategy-3 (SFDI wide-field) leads in this corpus; useful as an up-to-date 2026 survey anchor rather than a measurement result. *Metadata (title-type, venue, year, DOI) confirmed via search-index snippet; frontiersin.org egress-blocked to direct fetch — treat as reported-not-verified.*
- **Two photoacoustic spectral-coloring compensation techniques adapted to human in-vivo oxygenation measurements** — Khodaverdi A., Jayet B., Erlöv T., Albinsson J., Merdasa A., Gustafsson N., Sheikh R., Malmsjö M., Andersson-Engels S., Cinthio M. (Lund University) · *Biomedical Optics Express* **16**(6):2217–2231 (**2025**). Compares/adapts two spectral-coloring compensation methods on real human in-vivo PA data (finger, tissue-level). **Tissue-level, NOT venous-specific**, but a direct method sibling to the deep-vein decoloring problem (§2.2 APM+). *DOI numeral not directly readable (opg.optica.org egress-blocked); cite via BOE 16(6):2217 locator, DOI unverified.*
- **Near-infrared spectroscopy demonstrates preserved and reproducible resting skeletal muscle oxygenation across anatomical sites in stable heart failure** — *Am. J. Physiol. Heart Circ. Physiol.* (2026) · DOI 10.1152/ajpheart.00398.2026. **Tissue-level (StO₂), NOT venous.** CW-NIRS reproducibility study; value is as a 2026 StO₂-reproducibility baseline for the wearable/tissue-oximetry device class (§1.3/§1.4). *Snippet-verified only.*
- **Retinal Oximetry: New Insights into Ocular and Systemic Diseases** — Zhang W., Tu X., Wang X., et al. · *Graefe's Archive for Clinical and Experimental Ophthalmology* 263:2101–2115 (2025) · DOI 10.1007/s00417-025-06831-8 · PMID 40254630 · PMC12414079. Review consolidating retinal oximetry across spectrophotometric-fundus, hyperspectral, and vis-OCT modalities; the review-level companion to the §2.5 HSI system and the §2.4 vis-OCT anchor.
- **Diffuse Optical Spectroscopy and Imaging X (SPIE Proc. Vol. 13935, 2025)** — proceedings-level DOS/DOI collection; the current SPIE venue for respiration-modulation venous DOS methods. Listing-verified only.
- **Integrated spectral and depth compensation for sO₂ and total-hemoglobin estimation in PAT for ovarian-lesion diagnosis (ISDC)** — *Biomed. Opt. Express*-lineage, 2026 · PMC12869027. Deep-tissue PAT sO₂ fluence compensation; **not venous-specific** (ovarian tissue). Method lead for the deep-vein decoloring problem (§2.2). Snippet-verified only.
...
- **Deep Learning-Driven Quantitative Spectroscopic PA Imaging for Segmentation and Oxygen Saturation Estimation (Hybrid-Net)** — arXiv:2512.15394 (Dec 2025). Joint vessel segmentation + sO₂ without explicit fluence estimation; not venous-specific but relevant to the deep-vein PA decoloring problem (§2.2). arxiv.org egress-blocked; re-verified via ADS record 2025arXiv251215394S + index snippet.
- **Optical Inversion and Spectral Unmixing of Spectroscopic PA Images with Physics-Informed Neural Networks (SPOI-AE)** — arXiv:2602.16357 (submitted 2026-02-18). Non-linear PA optical-inversion/unmixing autoencoder; unmixing validated on simulated mouse-lymph-node phantoms; not venous-specific. Method lead. Re-confirmed today via arXiv index snippet.
...
- **Machine-learning-enabled multiple-illumination quantitative optoacoustic oximetry imaging in humans** — PMC9203099 (arXiv:2202.01482). Multiple-illumination + learned spectral decoloring for quantitative PA sO₂ in humans; tissue/vessel-level, not venous-specific. Method lead underpinning the deep-vein decoloring family (§2.2 / Hybrid-Net / Khodaverdi).
- **Learned Spectral Decoloring enables Photoacoustic Oximetry** — *Scientific Reports* 11:6565 (2021) · DOI 10.1038/s41598-021-83405-8 · arXiv:1902.05839. Foundational learned-decoloring method; conceptual root of the data-driven-unmixing leads above. Not venous-specific.
- **Improved Spectral Inversion of Blood Oxygenation due to Reduced Tissue Scattering: Towards NIR-II Photoacoustic Imaging** — bioRxiv 2024.08.08.607178. NIR-II wavelengths cut blood sO₂ estimation error ~50 % vs NIR-I. Wavelength-selection lead for the deep-vein decoloring problem (§2.2); not venous-specific.
...
- **Near-Infrared Spiroximetry** (respiration-frequency-filtered NIRS venous saturation; Franceschini/Fantini lineage; *J. Appl. Physiol.* 92(1):372, 2002; PMC3786737). Foundational method for isolating the venous component by respiratory modulation — the physiological root of the "filter at the respiration frequency" strategy shared by §1.2/§1.3 and cerebral-venous DOS. Standing method lead; re-confirmed today (agrees with cooximetry over 20–95 % SvO₂).
- **Measurement of venous oxyhaemoglobin saturation in the adult human forearm by NIRS with venous occlusion** — *Med. Biol. Eng. Comput.* (Springer, BF02534086 lineage). Foundational venous-occlusion NIRS forearm SvO₂ method; significant correlation with cooximetry of superficial venous blood. Standing method lead, re-confirmed today; conceptual sibling of §1.3.
...
Today's two-day sweep (08-21 → 08-23) produced **no new intravascular venous optical result** for either topic, and **no item genuinely new to the ranked corpus**. The only genuinely new-to-corpus find is a **2026 *Frontiers in Photonics* editorial on diffuse-optics medical imaging** — a tissue-level review, not a venous measurement result — logged as a standing survey lead. **No new systemic SvO₂/ScvO₂ measurement paper appeared — the twentieth consecutive dry cycle** for true central/peripheral venous work once arterial-only and tissue-level items are excluded. The most recent genuinely-new *venous* result in the corpus remains the 08-13 Tran et al. hyperspectral retinal imager (§2.5), in the **retinal per-vessel venular** sub-cluster.
...
*Scan generated 2026-08-23 (UTC). Metadata cross-checked across ≥2 search-index snippets per item; pubmed.ncbi.nlm.nih.gov, journals.physiology.org, www.spiedigitallibrary.org, www.frontiersin.org, and arxiv.org were egress-blocked, and publisher full-text pages returned HTTP 403 to direct fetch in this environment (source-/policy-side; agent proxy healthy), so items flagged "full text not read" / "snippet-verified" are abstract- or snippet-level and flagged unverified fields are noted inline.*
