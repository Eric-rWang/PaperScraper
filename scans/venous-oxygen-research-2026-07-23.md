# Venous Oxygen Research Scan — 2026-07-23

**Search window:** Twenty-seventh scan in the series, run **two days** after 2026-07-21 (no scan on 07-22). Emphasis on work published or first-surfacing after 07-21, with the standard fallback to the best-available venous-specific work already catalogued. Sources searched today: PubMed/PMC, arXiv (incl. physics.med-ph new-listing sweep), bioRxiv/medRxiv, Optica (Biomed. Opt. Express, Optics Letters, Applied Optics), SPIE / *J. Biomed. Opt.*, *Photoacoustics* (ScienceDirect), World Scientific (*J. Innovative Optical Health Sciences*), IEEE Xplore, Nature / *Sci. Rep.* / *Commun. Med.*, Wiley (*Advanced Science*, *J. Biophotonics*), Springer, De Gruyter, MDPI, *CHEST* / *J. Cardiothoracic and Vascular Anesthesia*, ClinicalTrials.gov, ResearchGate, Semantic Scholar, ADS, and lab publication pages.

**Verification caveat:** As in every prior scan, publisher **full-text** pages — including worldscientific.com, journal.chestnet.org / sciencedirect.com, arxiv.org, pmc.ncbi.nlm.nih.gov, opg.optica.org, advanced.onlinelibrary.wiley.com and the Nature domains — returned **HTTP 403** to direct `WebFetch` in this environment today (re-confirmed on the World Scientific and CHEST DOIs). Every reference below was therefore cross-checked across **at least two independent search-index snippets** (Google Scholar-style result blocks + PubMed/ADS/ResearchGate/ScienceDirect listings); per-item notes state what was confirmed and what could not be read directly on a publisher page.

---

## ⚠️ Read this first — day summary

**No new venous-specific *primary* paper today — the sixth consecutive scan cycle with none.** Consistent with the series' standing observation, truly novel non-invasive **venous**-optical work publishes at very low volume, and today's two-day sweep produced no new SvO₂/ScvO₂ demonstration. The venous top-5 sets for both topics are unchanged from 07-21/07-17 and carried forward with scores held.

The genuinely **new-to-corpus** items this cycle are three **review / secondary** works, none of which measures a vein:

- **★ NEW — "Quantitative oximetry with photoacoustic computed tomography: Principles, progress, and prospects"** (*J. Innovative Optical Health Sciences*, 2026; DOI 10.1142/S1793545826300065; special issue on AI-Empowered Biomedical Optical Imaging). A systematic **review of the fluence-heterogeneity / spectral-coloring bottleneck** that gates quantitative PACT sO₂ — the exact barrier every deep-vein PA method in this corpus lives or dies on. Review, not measurement; logged as a **standing technique lead**.
- **★ NEW — "Emerging Technology for Noninvasively Measuring Oxygen Saturations"** (*CHEST* 169(2):401–410, Feb 2026; DOI 10.1016/j.chest.2025.09.025; open access). A clinical review of non-invasive SpO₂/StO₂ technologies that **explicitly discusses photoacoustic tomography + ultrasound for internal-jugular venous sO₂ and PA-TEE for mixed-venous**. Review, not measurement; useful clinical-context lead.
- **★ NEW — "Non-Invasive Blood Oxygen Level Monitoring Using Bio-Impedance"** (Tom, Heydari, Yuce; *IEEE EMBC 2025*; DOI 10.1109/EMBC58623.2025.11254485). A **non-optical** bio-impedance approach to blood-oxygen estimation; general (not venous-specific). Logged only as an off-modality technique lead.
...
- **Integration insights:** The inverse-modeling / fluence-correction leg of the program; the physics-simulation twin of the self-supervised-learning approach in §1.3. Its accuracy is bounded by the pathlength/fluence assumptions the DPF preprint (standing lead) reformulates — and its class of forward-model dependence is exactly what today's NEW JIOHS PACT-oximetry review anatomises. *Cross-confirmed via Optica listing + Semantic Scholar; full text 403 (flagged).*
...
*No new venous-specific primary today.* The standing set carried forward with scores held; the new-to-corpus items this cycle are reviews and are logged under Standing context leads.
...
- **Integration insights:** The deep-vein anchor that everything else is measured against; APM+ (§2.2), APRECOT and the DPF model (standing leads) are all, in different ways, attempts to make this class of measurement quantitative and fluence-robust without an ultrasound co-registration crutch. It is cited as the venous PA exemplar in today's NEW *CHEST* review. *Metadata cross-confirmed via arXiv + ADS; full text 403 (flagged).*
...
- **★ NEW this cycle — "Quantitative oximetry with photoacoustic computed tomography: Principles, progress, and prospects"** — *J. Innovative Optical Health Sciences*, 2026 (special issue "AI-Empowered Biomedical Optical Imaging"; DOI **10.1142/S1793545826300065**). A systematic **review** of quantitative PACT sO₂: it frames optical-fluence heterogeneity / **spectral coloring** as the central barrier to accurate deep-tissue sO₂ and catalogues the correction families (photon-transport modeling, acoustic-spectrum self-calibration, multimodality fusion, statistical inference, learning-based methods). **Not a venous measurement**, but it is the most directly-relevant *survey* of the exact problem the IJV-PA anchor (§2.1), APM+ (§2.2), Hybrid-Net, APRECOT and ISDC all attack — a useful map of where deep-vein PA oximetry sits in the method space. *Title/venue/DOI/special-issue cross-confirmed via two search snippets; World Scientific full text and full author list 403-blocked and **unverified** (flagged).*
- **★ NEW this cycle — "Emerging Technology for Noninvasively Measuring Oxygen Saturations"** — *CHEST* **169(2):401–410, Feb 2026** (DOI **10.1016/j.chest.2025.09.025**; open access; single-author clinical review, literature searched through 2025-07-25). Surveys non-invasive SpO₂/StO₂ technologies and, notably, calls out **photoacoustic tomography + ultrasound for internal-jugular venous sO₂** and **PA-TEE for mixed-venous** as emerging non-invasive venous approaches. **Review, not measurement**; valuable as the clinical-framing lead that situates the corpus's venous PA work (§2.1) inside pulmonary/critical-care practice. *Title/venue/pages/DOI cross-confirmed via ScienceDirect + Ovid + CHEST listings; full text 403 and author name unverified (flagged).*
- **★ NEW this cycle — "Non-Invasive Blood Oxygen Level Monitoring Using Bio-Impedance"** (Tom, Heydari, Yuce; Monash) — *IEEE EMBC 2025* (DOI **10.1109/EMBC58623.2025.11254485**; PMID 41335757). **Non-optical** bio-impedance estimation of blood oxygen; general, **not venous-specific**. Logged only as an off-modality technique lead — a reminder that non-invasive oxygen sensing is being attacked outside optics too. *Authors/venue/DOI cross-confirmed via PubMed + ResearchGate; full text not read (flagged).*
- **APRECOT — Conditioning Deep Anatomical Prior Knowledge for Reconstruction of MSOT Images** (arXiv:2606.16835, June 2026; Franceschin, Scheel-Platz, Haim, Zahnd, Ntziachristos, Jüstel) — joint tissue segmentation + bulk-chromophore (oxygenation) recovery attacking the ill-posed MSOT fluence problem; **in-silico only**, not venous. Catalogued 07-17; standing lead.
- **Novel Differential Pathlength Factor (DPF) model for NIR diffuse optical imaging** (arXiv:2602.00283, submitted 2026-01-30) — Monte-Carlo-derived distance/property-dependent DPF models reducing modified-Beer-Lambert error at small source–detector separations; underpins every transcutaneous-NIRS venous method (§1.2, §1.5). Catalogued 07-17; standing lead.
- **Hybrid-Net — Deep-Learning-Driven Quantitative Spectroscopic PA Imaging** (arXiv:2512.15394, Dec 2025) — joint vessel segmentation + sO₂ without explicit fluence estimation; general PA-oximetry method, not venous-specific. Standing technique lead.
- **ISDC — Integrated Spectral and Depth Compensation for PA sO₂/THb** (*J. Biomed. Opt.* 31(2):026002, Feb 2026; DOI 10.1117/1.JBO.31.2.026002; PMC12869027) — depth+spectral fluence correction, transferable to deep-vein PA oximetry. Catalogued 07-09; standing lead.
- **SPIE 2026 hyperspectral whole-blood items** (Quantitative Bioimaging Laboratory / fei-lab.org) — algorithm-comparison and high-speed reflectance sO₂ estimation in whole blood; in-vitro metrology, not venous. Catalogued 07-21; metadata unverified (SPIE 403).
...
1. **Sparseness confirmed, not padded — sixth consecutive cycle with no new venous primary.** A two-day sweep across PubMed, arXiv (incl. the physics.med-ph new-listing page), bioRxiv/medRxiv, Optica, SPIE, World Scientific, Wiley, Nature, IEEE and MDPI produced **no new non-invasive venous-O₂ measurement paper** post-dating 07-21. The Topic-1 (true SvO₂) and Topic-2 (optical venous) top-5 sets are unchanged and carried forward with scores held. The §2.1 IJV-PA anchor, the §2.2 APM+ radial-vein result, and the §2.3 retinal vis-OCT result remain the anchors; nothing newer displaces them.

2. **Today's new signal is *synthesis*, not measurement — and it points at the same bottleneck.** Two of the three new items are reviews, and both foreground **fluence heterogeneity / spectral coloring** as the field's binding constraint: the JIOHS PACT-oximetry review makes it the organizing axis of the whole method space, and the CHEST clinical review names PA+US IJV and PA-TEE as the emerging non-invasive *venous* modalities to watch. That two independent 2026 reviews converge on the same barrier — the one APM+, APRECOT, the DPF model, Hybrid-Net and ISDC each attack from a different side — is external confirmation that the corpus is tracking the right problem, not a niche one.

3. **The central obstacle is unchanged: absolute quantification under unknown, wavelength- and depth-dependent fluence.** Every live thread converges on it — internal-reference calibration (APM+ §2.2; non-optically the MRI RV/LV T₂ ratio §1.4), global anatomical priors (APRECOT), better forward physics (DPF model), fluence-free deep learning (Hybrid-Net; §1.2 DNN+Monte-Carlo), depth+spectral compensation (ISDC), and blood-mimicking phantoms/algorithm benchmarking across the venous range (§2.5 + SPIE hyperspectral). The new JIOHS review is essentially a taxonomy of these same families. A clinically accurate deep-vein SvO₂ system will likely **stack** at least two; no single paper yet does.

4. **MRI remains the referee for the label problem.** T₂/intra-cardiac CMR oximetry (§1.3 SSL, §1.4 iSvO₂) measures true mixed-venous SvO₂ non-invasively and reference-grade — the natural validation target the jugular optical sensor (§1.1) and deep-vein PA/APM+ (§2.1–2.2) chronically lack. The SSL + uncertainty recipe (§1.3) is portable to the label-starved optical side.

5. **Open gaps (carried forward, still open):** (a) no continuous, calibrated, wearable optical SvO₂ device validated against blood-gas with published limits-of-agreement (Alqahtani n=3; APM+ n=8 healthy); (b) beyond APM+'s single-vessel radial-vein demonstration, no quantitative deep-venous PA sO₂ with an in-situ fluence reference across multiple deep sites and the full venous 40–75 % range; (c) no non-invasive optical/PA SvO₂ method benchmarked head-to-head against reference CMR oximetry — a study the maturity of §1.3/§1.4 now makes feasible. Today moved none of these; it added two authoritative reviews that map the terrain rather than extend it.

---

*Scan generated 2026-07-23 (UTC). No new venous-specific primary paper (sixth consecutive cycle); both topic top-5 sets carried forward with scores unchanged. Three new-to-corpus secondary items logged as standing context — two 2026 reviews (JIOHS quantitative-PACT-oximetry; CHEST emerging noninvasive-oxygen tech, which explicitly discusses venous PA) and one non-optical bio-impedance EMBC 2025 paper — all with metadata flagged where publisher pages were 403-blocked. Publisher full-text access was 403-blocked throughout this environment; every reference was cross-checked across ≥2 independent search-index snippets, with per-item verification notes and flags above.*
