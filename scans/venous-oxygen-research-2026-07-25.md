# Venous Oxygen Research Scan — 2026-07-25

**Search window:** Twenty-seventh scan in the series, run **four days** after 2026-07-21 (no scans on 07-22, 07-23, 07-24). Emphasis on work published or first-surfacing after 07-21, with the standard fallback to the best-available venous-specific work already catalogued. Sources swept today: PubMed/PMC, arXiv (incl. physics.med-ph new-listing sweep), bioRxiv/medRxiv, Optica (Biomed. Opt. Express, Optics Letters, Applied Optics), SPIE / *J. Biomed. Opt.*, *Photoacoustics* (ScienceDirect), IEEE Xplore, Nature / *Sci. Rep.* / *Commun. Med.*, Wiley (*Advanced Science*, *J. Biophotonics*), Springer, De Gruyter, MDPI (*Biosensors*), *CHEST* / ScienceDirect, ClinicalTrials.gov, ResearchGate, Semantic Scholar, ADS.

**Verification caveat:** As in every prior scan, publisher **full-text** pages — including journal.chestnet.org / sciencedirect.com (403 today on the CHEST article), arxiv.org, pmc.ncbi.nlm.nih.gov, opg.optica.org, advanced.onlinelibrary.wiley.com, the Nature domains and biorxiv.org — returned **HTTP 403** to direct `WebFetch` in this environment today. Every reference below was therefore cross-checked across **at least two independent search-index snippets** (Google Scholar-style result blocks + ADS/ResearchGate/PMC/Ovid/ScienceDirect listings); per-item notes state what was confirmed and what could not be read directly on a publisher page.

---

## ⚠️ Read this first — day summary

**No new venous-specific *primary* measurement paper today — the sixth consecutive scan cycle with none.** Consistent with the series' standing observation, truly novel non-invasive **venous**-optical work publishes at very low volume, and today's four-day sweep produced no new SvO₂/ScvO₂ demonstration. The venous top-5 sets for both topics are unchanged from 07-21 and carried forward with scores held.

The genuinely **new-to-corpus** items this cycle are both **secondary literature (reviews), not measurements**, and are logged under Standing context leads:

- **★ NEW — Gokhale, "Emerging Technology for Noninvasively Measuring Oxygen Saturations," *CHEST* 169(2):401–410, February 2026** (DOI 10.1016/j.chest.2025.09.025). A peer-reviewed clinical review that explicitly surveys the **non-invasive photoacoustic** route to blood/venous oxygenation — including the internal-jugular-vein PAT+US work and **PA-TEE mixed-venous** monitoring — alongside SpO₂/StO₂ methods. The first *CHEST*-level clinical framing of the deep-vein PA program in the corpus.
- **★ NEW — Zheng, Huang & Xia, "Review of Pulsation Signal Detection and Applications in Dynamic Photoacoustic Imaging," *Biosensors (MDPI)* 15(9):591, 2025** (DOI 10.3390/bios15090591; PMC12467494). A technique review of **pulsatile-signal extraction** in dynamic PA — the machinery for separating arterial (pulsatile) from venous (respiration-/non-pulsatile) components and for continuous sO₂ tracking at depth.

One minor **new lead**: a bioRxiv preprint on **non-invasive PA imaging of cerebral oxygenation in awake mice** (2025.10.02.679935) — tissue/cerebral, murine, **not** a systemic-venous measurement; noted only as a technique lead. Everything else returned today is **previously surfaced** or out-of-scope: the IJV-PA anchor (arXiv:2303.10775), APM+ radial-vein PA oximetry (Sastry et al., *Adv. Sci.* 2026), the Alqahtani jugular optical sensor (De Gruyter CDBME), the IJV DNN + Monte-Carlo work (*Optics Letters*), Mespere VO100 jugular NIRS, the McDiarmid MRI iSvO₂ model, the SSL intra-cardiac MR oximetry preprint, retinal vis-OCT / hyperspectral oximetry, PACT venous-flow, Hybrid-Net, the APRECOT MSOT-prior preprint, the DPF-model preprint, the sulfate blood-phantom paper, and the two SPIE 2026 hyperspectral whole-blood items. **No new primary venous demonstration.**
...
*No new venous-specific primary today.* The standing set carried forward with scores held; the new items this cycle are two reviews, logged under Standing context leads.
...
- **Integration insights:** The deep-vein anchor that everything else is measured against; APM+ (§2.2), APRECOT and the DPF model (standing leads) are all, in different ways, attempts to make this class of measurement quantitative and fluence-robust without an ultrasound co-registration crutch. Now also the centerpiece of the new *CHEST* clinical review (standing lead). *Metadata cross-confirmed via arXiv + ADS; full text 403 (flagged).*
...
- **★ NEW this cycle — Gokhale S., "Emerging Technology for Noninvasively Measuring Oxygen Saturations," *CHEST* 169(2):401–410, February 2026** (DOI 10.1016/j.chest.2025.09.025; article ID S0012-3692(25)05393-0). A clinical-audience review of non-invasive blood/tissue oxygen measurement that explicitly covers the **photoacoustic** route — the dual-wavelength **IJV PAT+US** demonstration (§2.1) and **PA-TEE mixed-venous** monitoring — as the emerging answer to the unmet need for a non-invasive SvO₂ monitor, alongside SpO₂/StO₂ methods and their limitations. Not a measurement; matters as the **first *CHEST*-level clinical framing** of the deep-vein PA program and a citable positioning of where the field's venous thrust sits clinically. *Title, sole author (Sanjay Gokhale, MD), venue, volume/issue/pages and DOI cross-confirmed via Ovid + ScienceDirect + journal.chestnet.org listings; full text 403 (flagged).*
- **★ NEW this cycle — Zheng W., Huang C., Xia J., "Review of Pulsation Signal Detection and Applications in Dynamic Photoacoustic Imaging," *Biosensors (MDPI)* 15(9):591, 2025** (DOI 10.3390/bios15090591; PMC12467494; U. at Buffalo). Technique review of **pulsatile-signal extraction** in dynamic PA — how the pulsatile (arterial) component is isolated and used to track heart rate and blood sO₂ at depth (>10 mm). Relevant to the venous program precisely by *complement*: separating the pulsatile arterial signal is the first step toward attributing the residual/respiration-modulated signal to the vein (cf. respiration-frequency NIRS, §1.5 standing context). Not a venous measurement; a methods lead for continuous/dynamic sO₂. *Title, authors, venue, DOI cross-confirmed via PMC + ResearchGate (pub. 394725934); full text 403 (flagged).*
- **NEW lead (minor, out-of-core-scope) — Non-invasive photoacoustic imaging of cerebral oxygenation and hemoglobin content in awake mice** — bioRxiv 2025.10.02.679935 (posted Oct 2025). Murine, cerebral/tissue-level PA oxygenation; **not** a systemic-venous or human measurement. Logged only as a technique lead on awake-animal PA oximetry robustness. *Title/date from search snippet; bioRxiv full text 403 (flagged); details unverified.*
- **Two SPIE 2026 hyperspectral whole-blood items** (Quantitative Bioimaging Laboratory / fei-lab.org) — an *algorithm-comparison* study for sO₂ estimation in whole blood by diffuse-reflectance hyperspectral imaging (≈March 2026) and a **high-speed reflectance-based** hyperspectral sO₂ approach (≈April 2026). In-vitro / tissue-level blood-optics metrology; **not** venous. Catalogued 07-21; metadata SPIE-403 and **unverified** (flagged).
...
- **In-vivo continuous monitoring of mixed venous SvO₂ by PA-TEE** (SPIE 9689E..2U, 2016 lineage; swine) — minimally-invasive esophageal PA oximetry; the mixed-venous PA thread now cited in the new *CHEST* review. Standing lead.
...
1. **Sparseness confirmed, not padded — sixth consecutive cycle with no new venous primary.** A four-day sweep across PubMed, arXiv (incl. the physics.med-ph new-listing page), bioRxiv/medRxiv, Optica, SPIE, Wiley, Nature, MDPI and *CHEST* produced **no new non-invasive venous-O₂ measurement paper** post-dating 07-21. The Topic-1 (true SvO₂) and Topic-2 (optical venous) top-5 sets are unchanged and carried forward with scores held. The §2.1 IJV-PA anchor, the §2.2 APM+ radial-vein result, and the §2.3 retinal vis-OCT result remain the anchors; nothing newer displaces them.

2. **Today's only new signal is secondary literature — reviews, not measurements.** The two new-to-corpus items are both *reviews*: a **February-2026 *CHEST*** clinical survey (Gokhale) that, for the first time in the corpus, frames the non-invasive **deep-vein / mixed-venous photoacoustic** program (IJV-PAT, PA-TEE) for a mainstream pulmonary/critical-care readership; and a **2025 *Biosensors*** technique review (Zheng/Huang/Xia) of **pulsatile-signal detection in dynamic PA** — the arterial-vs-venous separation machinery underneath continuous sO₂ tracking. Neither measures a vein. They are valuable as *positioning* (the field is now being reviewed clinically) and as *method scaffolding*, and are scored out of the top-5.

3. **The central obstacle is unchanged: absolute quantification under unknown, wavelength- and depth-dependent fluence.** Every live thread converges on it from a different side — internal-reference calibration (APM+ §2.2; non-optically the MRI RV/LV T₂ ratio §1.4), global anatomical priors (APRECOT), better forward physics (DPF model), fluence-free deep learning (Hybrid-Net; §1.2 DNN+Monte-Carlo), depth+spectral compensation (ISDC), and blood-mimicking phantoms/algorithm benchmarking across the venous range (§2.5 + the SPIE hyperspectral items). The new dynamic-PA pulsation review adds a fourth, orthogonal lever — **temporal/pulsatile discrimination** — for isolating the venous compartment. A clinically accurate deep-vein SvO₂ system will likely **stack** several of these; no single paper yet does.

4. **Clinical framing is arriving before the definitive measurement.** The *CHEST* review is a leading indicator: the non-invasive venous-PA idea is now being surveyed for practitioners even though the primary evidence base is still thin (Alqahtani n=3; APM+ n=8 healthy; IJV-PAT n=7). MRI remains the referee for the label problem — T₂/intra-cardiac CMR oximetry (§1.3 SSL, §1.4 iSvO₂) measures true mixed-venous SvO₂ non-invasively and reference-grade, the natural validation target the optical/PA methods chronically lack.

5. **Open gaps (carried forward, still open):** (a) no continuous, calibrated, wearable optical SvO₂ device validated against blood-gas with published limits-of-agreement; (b) beyond APM+'s single-vessel radial-vein demonstration, no quantitative deep-venous PA sO₂ with an in-situ fluence reference across multiple deep sites and the full venous 40–75 % range; (c) no non-invasive optical/PA SvO₂ method benchmarked head-to-head against reference CMR oximetry — a study the maturity of §1.3/§1.4 now makes feasible. Today moved none of these; it added a clinical review and a methods review that *frame* (a)–(c) rather than close them.

---

*Scan generated 2026-07-25 (UTC). No new venous-specific primary paper (sixth consecutive cycle); both topic top-5 sets carried forward with scores unchanged. Two new-to-corpus **reviews** logged as standing context — Gokhale, *CHEST* 169(2), Feb 2026 (venous PA clinical framing), and Zheng/Huang/Xia, *Biosensors* 15(9):591, 2025 (dynamic-PA pulsation detection) — plus one minor murine cerebral-PA bioRxiv lead. Publisher full-text access was 403-blocked throughout this environment; every reference was cross-checked across ≥2 independent search-index snippets, with per-item verification notes and flags above.*
