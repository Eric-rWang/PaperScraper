# Venous Oxygen Research Scan — 2026-08-22

**Search window:** Fortieth scan in the series, run **one day** after 2026-08-21. Emphasis on work published or first-surfacing after 08-21, with the standard fallback to the best-available venous-specific work already catalogued. Sources swept today: PubMed/PMC, arXiv (physics.med-ph / eess.IV new-listing sweep), bioRxiv/medRxiv, Optica (Biomed. Opt. Express, Optics Letters, Applied Optics) incl. Optica Open preprints, SPIE / *J. Biomed. Opt.*, *Photoacoustics* (ScienceDirect), Springer, Wiley (*Advanced Science*, *Adv. Healthcare Mater.*, *J. Biophotonics*), De Gruyter, IOP (*J. Phys. Photonics*), MDPI (*Sensors/Biosensors/Applied Sciences*), IEEE Xplore, Nature / *Sci. Rep.* / *Commun. Med.*, American Physiological Society journals, ClinicalTrials.gov, plus Semantic Scholar / Google-Scholar-style index snippets and ResearchGate.

**Verification caveat:** Publisher **full-text** pages and several databases remain unreachable for direct `WebFetch` in this environment. The usual publisher/preprint hosts (pmc.ncbi.nlm.nih.gov, opg.optica.org, preprints.opticaopen.org, iopscience.iop.org, link.springer.com, sciencedirect.com, wiley.com, spiedigitallibrary.org, journals.physiology.org) return **HTTP 403 / EGRESS_BLOCKED** to direct fetch; arxiv.org / pubmed.ncbi.nlm.nih.gov are egress-blocked on direct new-listing fetch. The blocks are source-/policy-side, not relay failures (agent proxy healthy). Every reference below was therefore cross-checked across **≥2 independent search-index snippets**; per-item notes state what was confirmed and what could not be read directly on a publisher page.

---

## ⚠️ Read this first — day summary

**No new venous-specific optical measurement paper first-surfaced in the one-day 08-21 → 08-22 window.** Repeated targeted sweeps (SvO₂ / ScvO₂ optical, jugular PA/NIRS, deep-vein PA, vis-OCT venular oximetry, hyperspectral fundus, DOS/DOI respiration-modulation, SFDI) returned only the **standing corpus** plus **two items new to this corpus but not venous-specific** — both tissue-level wearable-NIRS entries logged under the standing-context section, not as ranked venous results.

**No item in the ranked top-5 lists is genuinely new to the corpus today.** The 08-13 hyperspectral retinal system (Tran et al., *J. Biomed. Opt.* 31(3):036006, §2.5) remains the most recent genuinely-new intravascular-venular result and is carried forward unchanged.

**No new venous-specific systemic (SvO₂/ScvO₂) measurement paper today — the nineteenth consecutive scan cycle with none.** All standing Topic-1 anchors and the deep-vein PA anchors are unchanged and carried forward with scores held.
...
- **Integration insight:** Anchor for the "wearable venous pulse oximeter" thesis; every Topic-1 wearable/peripheral entry is a variation on isolating the venous component this device targets at the neck. The authors' own stated next step — calibration/validation against gold-standard blood-gas analysers — remains the open gate for the whole optical-jugular class.
...
- **Integration insight:** The wearable-form embodiment of the venous-oximetry goal; its arterial/venous separation problem is the same one §1.3 attacks by modulation and §1.1 sidesteps by anatomy. The standing JMIR hypoxia-accuracy caution bears directly on this device class, and today's new wearable-FD-NIRS lead (below) is a hardware sibling on the quantitative-separation side.
...
- **Integration insight:** The device most directly bridging Topic-1's clinical need and Topic-2's optical physics on the systemic-venous front; validation-cohort agreement is the key open question for the whole jugular-NIRS class. The pediatric jugular-NIRS validation (r = 0.91; bias 2.92 %, LoA −5.2 % to +11 %; TÜBİTAK *Turk. J. Med. Sci.* 50(5), PMC7491293) grounds the technique's agreement claim; re-confirmed today via ScienceDirect record (S1053077023007826) + PMC7491293 snippet.
...
**Topic-1 clinical-trial watch (context, not a paper):** ClinicalTrials.gov **NCT06511999** — *Feasibility and Validation of Continuous Measurement of Jugular Venous Oxygen Saturation (SjO₂) in Comatose Patients After Cardiac Arrest* (RECRUITING). Logged for situational awareness only; the SjO₂ measurement is **catheter-based (invasive)**, so it is **out of scope** for non-invasive optical venous oximetry — noted here so future scans do not re-surface it as an optical result.
...
*No new item in the ranked set today.* Measurement anchors carried forward with scores held; the 08-13 hyperspectral retinal system (§2.5) remains the most recent genuinely-new entry.
...
- **Novelty:** Demonstrates human IJV oxygenation from multi-wavelength PA (dual-wavelength PAT + ultrasound, seven healthy volunteers), pushing PA oximetry from superficial microvessels to a clinically meaningful deep venous target.
...
- **Metadata flag:** arxiv.org egress-blocked today; re-verified via ≥2 index snippets (arXiv abstract listing + ADS record 2014SPIE.8943E..1MG lineage entry).
...
- **Relevance:** 8.5/10 — per-vessel retinal **vein** sO₂ with reported repeatability SD ≈ 2.3 % in veins; artery RMSE vs pulse oximeter ≈ 2.1 % across 18 participants.
...
- **Metadata note:** Title/venue/DOI re-confirmed today via Nature *Communications Medicine* landing + PMC10126115 + PubMed 37095177 snippet.
...
- **Relevance:** 7.5/10 — a 2026 hyperspectral fundus system that measures **per-vessel retinal venule sO₂ (≈58–65 %)** alongside arteriole sO₂ (≈91–98 %) and vessel diameter; a true intravascular venular optical readout, though retinal per-vessel, **not systemic SvO₂**.
- **Novelty:** High-resolution snapshot/hyperspectral retinal imager (snapshot hyperspectral camera + high-resolution RGB camera + beamsplitter + imaging endoscope) that recovers vessel diameter *and* oxygenation simultaneously; a **deep-learning pansharpening** step fuses high-spatial and high-spectral channels (reported pansharpening RMSE 2.15 ± 0.64, correlation 0.96 ± 0.05). Reported venous sO₂ (mean ≈ 64.5 ± 3.5 % in the validation cohort) matches the accepted retinal venous norm, giving physiological face-validity to the calibration.
- **Integration insight:** A 2026 entry in the retinal-oximetry cluster (with ADS-vis-OCT §2.4). It advances the *spatial–spectral fusion* angle — using deep learning to reconcile the resolution/spectral-sampling trade-off that limits fundus HSI — the same class of confound (per-vessel diameter, vessel boundary, media transparency) the vis-OCT and deep-vein PA work must correct. Reinforces that retinal venular oximetry remains the most mature, best-validated proving ground for per-vessel venous optical measurement, and offers a cheaper camera-based route (vs vis-OCT / PA hardware) toward the same per-vessel venous readout.
- **Metadata flag:** Title, authors, venue, volume/issue/article-number and DOI cross-confirmed across ≥2 independent index snippets (SPIE Digital Library listing + PMC12997856 + UT Southwestern Pure). **Full text not read** — spiedigitallibrary.org and pmc.ncbi.nlm.nih.gov were egress-blocked to direct fetch; numeric performance figures are snippet-level and should be treated as reported-not-verified.
...
- **⭐ NEW TO CORPUS — Wearable frequency-domain near-infrared spectroscopy (FD-NIRS) system** — (Notre Dame Dept. of Electrical Engineering + UC Irvine EECS group; corresponding author **Thomas D. O'Sullivan**) · *Biomedical Optics Express* **17**(2):555–571 (**published 2026-01-05**; accepted 2025-12-28). A real-time **multi-frequency (50–350 MHz)** wearable FD-NIRS device built on a custom **ASIC**, with 685 nm and 850 nm laser diodes and a SiPM detector; ~37 g without battery, <7 × 3 × 3 cm, 14.7 Hz measurement rate, phantom optical-property accuracy 0.0007 mm⁻¹ (μₐ) / 0.08 mm⁻¹ (μ′ₛ). **Tissue-level (StO₂), NOT venous-specific** — it quantifies HbO/HHb and tissue saturation, with the deoxy-hemoglobin (HHb) signal noted as arising from the venous compartment. Its value to this corpus is as a **2026 hardware substrate for the quantitative-separation venous strategy**: FD-NIRS recovers *absolute* absorption/scattering (so absolute HbO/HHb, not just relative change), which is precisely what the respiration-modulation venous-NIRS methods (spiroximetry lineage; §1.2/§1.3) need to convert an isolated venous component into a calibrated SvO₂. A wearable, absolute-quantitative FD-NIRS front-end lowers the hardware barrier for the wearable-venous device class (§1.4). Logged as a method/hardware lead, not a ranked venous result. *Metadata (title, venue, vol/issue/pages, date, corresponding author) cross-confirmed across PMC12904531 snippet + Optica Open preprint listing (preprints.opticaopen.org/.../30632807) + BOE index snippet; DOI numeral not directly readable (pmc/opg/preprints.opticaopen.org egress-blocked) — treat raw DOI as unverified, cite via BOE 17(2):555.*
- **⭐ NEW TO CORPUS — Advances in fully integrated wearable near-infrared spectroscopy: hardware innovations and biomedical applications** — (authors unverified) · *Journal of Physics: Photonics* (IOP), 2026 · DOI 10.1088/2515-7647/ae6ae4. Topical state-of-the-art **review** synthesizing fully-integrated wearable NIRS hardware across CW, time-domain and frequency-domain techniques, spanning arterial and venous hemodynamic/tissue-oxygenation applications. **Tissue-level context, NOT a venous measurement result.** Useful as a 2026 review-level map of the wearable-NIRS hardware landscape that the Topic-1 wearable-venous device class (§1.3/§1.4) and the new FD-NIRS lead sit within. *Metadata: title/venue/DOI cross-confirmed via IOPscience listing + a second index snippet; authors and exact publication month not verifiable (iopscience.iop.org egress-blocked). Reported-not-verified.*
- **Two photoacoustic spectral-coloring compensation techniques adapted to the context of human in-vivo oxygenation measurements** — Khodaverdi A., Jayet B., Erlöv T., Albinsson J., Merdasa A., Gustafsson N., Sheikh R., Malmsjö M., Andersson-Engels S., Cinthio M. (Lund University) · *Biomedical Optics Express* **16**(6):2217–2231 (**2025**). Adapts two spectral-coloring compensation methods to real human in-vivo PA data (phantom relative MSE reduced from ~65 % to ~1.2 % at highest concentration; applied to in-vivo human **finger** sO₂ maps). **Tissue-level, NOT venous-specific**, but a direct method sibling to the deep-vein decoloring problem (§2.2 APM+) and one of the few papers testing fluence/spectral-coloring correction on *actual human in-vivo* PA data. *DOI numeral not directly readable; cite via BOE 16(6):2217. Reported-not-verified.*
- **Near-infrared spectroscopy demonstrates preserved and reproducible resting skeletal muscle oxygenation across anatomical sites in stable heart failure** — *Am. J. Physiol. Heart Circ. Physiol.* (2026) · DOI 10.1152/ajpheart.00398.2026. **Tissue-level (StO₂), NOT venous.** CW-NIRS reproducibility study; StO₂ is a mixed arterial+venous microvascular quantity. 2026 StO₂-reproducibility baseline for the wearable/tissue-oximetry device class (§1.3/§1.4). *journals.physiology.org egress-blocked; snippet-verified only.*
- **Retinal Oximetry: New Insights into Ocular and Systemic Diseases** — Zhang W., Tu X., Wang X., et al. · *Graefe's Archive for Clinical and Experimental Ophthalmology* 263:2101–2115 (2025) · DOI 10.1007/s00417-025-06831-8 · PMID 40254630 · PMC12414079. Review consolidating retinal oximetry across spectrophotometric-fundus, hyperspectral, and vis-OCT modalities. Review-level companion to §2.5 / §2.4.
- **Diffuse Optical Spectroscopy and Imaging X (SPIE Proc. Vol. 13935, 2025)** — proceedings-level DOS/DOI collection; the current SPIE venue for respiration-modulation venous DOS methods (spiroximetry, cerebral-venous DOS). Listing-verified only.
- **Integrated spectral and depth compensation for sO₂ and total-hemoglobin estimation in PAT for ovarian-lesion diagnosis (ISDC)** — *Biomed. Opt. Express*-lineage, 2026 · PMC12869027. Deep-tissue PAT sO₂ via spectral+depth fluence compensation; **not venous-specific** (arterial+venous tissue, ovarian). Method lead for the deep-vein decoloring problem (§2.2). Snippet-verified only.
...
- **Deep Learning-Driven Quantitative Spectroscopic PA Imaging for Segmentation and Oxygen Saturation Estimation (Hybrid-Net)** — arXiv:2512.15394 (Dec 2025). Joint vessel segmentation + sO₂ estimation without explicit fluence estimation; MC-simulated sPA (700/850 nm), retrained on phantoms. Not venous-specific but relevant to the deep-vein PA decoloring problem (§2.2). arxiv.org egress-blocked; re-verified via ADS record 2025arXiv251215394S + index snippet.
- **Optical Inversion and Spectral Unmixing of Spectroscopic PA Images with Physics-Informed Neural Networks (SPOI-AE)** — arXiv:2602.16357 (surfaced 06-11). Non-linear PA optical-inversion/unmixing autoencoder; not venous-specific. Method lead.
...
- **Machine-learning-enabled multiple-illumination quantitative optoacoustic oximetry imaging in humans** — PMC8336722 / PMC9203099. Multiple-illumination + learned spectral decoloring for quantitative PA sO₂ in humans; tissue/vessel-level, not venous-specific. Method lead underpinning the deep-vein decoloring family (§2.2 / Hybrid-Net / Khodaverdi).
- **Learned Spectral Decoloring enables Photoacoustic Oximetry** — *Scientific Reports* 11:6565 (2021) · DOI 10.1038/s41598-021-83405-8 · arXiv:1902.05839 · PMC7985523. Foundational learned-decoloring method; conceptual root of the data-driven-unmixing leads above. Not venous-specific.
- **Improved Spectral Inversion of Blood Oxygenation due to Reduced Tissue Scattering: Towards NIR-II Photoacoustic Imaging** — bioRxiv 2024.08.08.607178. NIR-II wavelengths cut blood sO₂ estimation error ~50 % vs conventional NIR-I. Wavelength-selection lead for the deep-vein decoloring problem (§2.2); not venous-specific.
...
- **Anthropomorphic tissue-mimicking phantoms for oximetry validation in multispectral optical imaging** — arXiv:2503.23161. Anthropomorphic phantom framework for validating multispectral/PA oximetry; metrology lead. Not venous-specific.
- **Photoacoustic Imaging Phantoms for Assessing Image Quality and Oximetry Performance** — FDA CDRH-RST resource. Regulatory-science phantom/reference for PA oximetry validation; not a venous result, but relevant metrology context for the device-pathway anchors (§1.6, §2.1/§2.2). Listing-verified only.
...
- **Near-Infrared Spiroximetry** (respiration-frequency-filtered NIRS venous saturation; Franceschini/Fantini lineage; *J. Appl. Physiol.* 92(1):372, 2002; PMC3786737). Foundational method for isolating the venous component by respiratory modulation — the physiological root of the "filter at the respiration frequency" strategy shared by §1.2/§1.3 and cerebral-venous DOS. The new FD-NIRS hardware lead (above) is a modern quantitative front-end for exactly this method. Standing method lead; re-confirmed today.
...
- **Noninvasive optical quantification of cerebral venous oxygen saturation in humans** — PMID 24439329 (*Acad. Radiol.*, 2014; PMC4126245). Respiration-frequency-selected NIRS validated against a gold-standard cerebral-venous measurement; the cerebral-venous companion to the spiroximetry lead. Standing method lead, re-confirmed today.
- **Noninvasive tracking of mixed venous oxygen saturation via NIRS cerebral oximetry** — *Scientific Reports* 13, s41598-023-49078-1 (2023). Retrospective study relating cerebral-oximetry NIRS to mixed venous saturation; a tissue-NIRS surrogate for systemic venous. Context lead for the jugular/cerebral-NIRS class (§1.5). Snippet-verified.
...
- **Photoacoustic transesophageal echocardiography (PA-TEE) for mixed venous oxygen saturation** — ADS 2016SPIE.9689E..2UL (conference-presentation lineage). Early concept for continuous non-invasive SvO₂ monitoring by integrating TEE with PA oximetry; targets a *mixed venous* readout. Standing concept lead; not a recent dated paper.
...
Today's one-day sweep (08-21 → 08-22) produced **no new intravascular venous optical result** for either topic, and **no item genuinely new to the ranked corpus**. The two genuinely new-to-corpus finds are both **tissue-level wearable-NIRS** items — a 2026 *Biomed. Opt. Express* wearable **FD-NIRS** hardware paper (O'Sullivan group, Notre Dame/UC Irvine) and an IOP wearable-NIRS **review** — logged as method/context leads, not venous results. **No new systemic SvO₂/ScvO₂ measurement paper appeared — the nineteenth consecutive dry cycle** for true central/peripheral venous work once arterial-only and tissue-level items are excluded. The most recent genuinely-new *venous* result in the corpus remains the 08-13 Tran et al. hyperspectral retinal imager (§2.5), in the **retinal per-vessel venular** sub-cluster.
...
2. **Signal modulation / separation** to lift a small venous component out of a noisy mixed background (peripheral-venous modulation §1.3, e-tattoo spatial filtering §1.4, DNN inversion §1.2, respiration-frequency spiroximetry/cerebral-venous DOS, PPG-waveform venous oximetry). **Today's new wearable FD-NIRS lead lands here on the hardware side**: because FD-NIRS recovers *absolute* absorption (hence absolute HbO/HHb rather than relative change), it is the kind of quantitative front-end the respiration-modulation venous-NIRS methods need to turn an isolated venous component into a calibrated SvO₂ — in a wearable, ASIC-scale form. The standing tissue-level NIRS leads (AJP-Heart, El Masry) remain the reminder that *reproducibility* of the underlying StO₂ signal — not just accuracy — is a live weakness this whole family must beat.
3. **Physics- and data-based decoloring / per-vessel correction** before unmixing (deep-tissue PA fluence correction §2.2, per-vessel spectral cleanup in vis-OCT §2.4, intravascular PACT §2.3, hyperspectral spatial–spectral fusion §2.5, plus the Hybrid-Net / SPOI-AE / learned-spectral-decoloring / distribution-informed / ISDC / NIR-II unmixing leads, the Khodaverdi in-vivo compensation lead, and the sulfate-/anthropomorphic-phantom and FDA-CDRH metrology).
...
*Scan generated 2026-08-22 (UTC). Metadata cross-checked across ≥2 search-index snippets per item; pubmed.ncbi.nlm.nih.gov, pmc.ncbi.nlm.nih.gov, opg.optica.org, preprints.opticaopen.org, iopscience.iop.org, journals.physiology.org, www.spiedigitallibrary.org, and arxiv.org were egress-blocked, and publisher full-text pages returned HTTP 403 to direct fetch in this environment (source-/policy-side; agent proxy healthy), so items flagged "full text not read" / "snippet-verified" are abstract- or snippet-level and flagged unverified fields are noted inline.*
