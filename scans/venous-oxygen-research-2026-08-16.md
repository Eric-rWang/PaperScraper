# Venous Oxygen Research Scan — 2026-08-16

**Search window:** Thirty-seventh scan in the series, run **one day** after 2026-08-15. Emphasis on work published or first-surfacing after 08-15, with the standard fallback to the best-available venous-specific work already catalogued. Sources swept today: PubMed/PMC, arXiv (physics.med-ph / eess.IV new-listing sweep, incl. the 2608.* August-2026 range), bioRxiv/medRxiv, Optica (Biomed. Opt. Express, Optics Letters, Applied Optics), SPIE / *J. Biomed. Opt.*, *Photoacoustics* (ScienceDirect), Springer, Wiley (*Advanced Science*, *J. Biophotonics*), De Gruyter, MDPI (*Sensors/Biosensors*), IEEE Xplore, Nature / *Sci. Rep.* / *Commun. Med.*, World Scientific, ClinicalTrials.gov, plus Semantic Scholar / Google-Scholar-style index snippets and ResearchGate.

**Verification caveat:** Publisher **full-text** pages and several databases were again unreachable for direct `WebFetch` today. The usual publisher hosts (link.springer.com, opg.optica.org, sciencedirect.com, wiley.com, spiedigitallibrary.org, pmc.ncbi.nlm.nih.gov) return **HTTP 403 / EGRESS_BLOCKED** to direct fetch; arxiv.org remains egress-blocked in this environment; **fei-lab.org (the Fei/UT-Southwestern group host) returned `EGRESS_BLOCKED`** to a direct PDF fetch today. The agent proxy itself reported healthy — the blocks are source-/policy-side, not relay failures. Every reference below was therefore cross-checked across **≥2 independent search-index snippets**; per-item notes state what was confirmed and what could not be read directly on a publisher page.

---

## ⚠️ Read this first — day summary

**No new venous-specific optical measurement paper first-surfaced in the one-day 08-15 → 08-16 window.** Repeated targeted sweeps (SvO₂ / ScvO₂ optical, jugular PA/NIRS, deep-vein PA, vis-OCT venular oximetry, hyperspectral, DOS/DOI, SFDI, and the arXiv 2608.* August-2026 new-listing range) returned only the **standing corpus**. The most recent genuinely-new intravascular-venular result remains the 08-13 Tran et al. hyperspectral retinal system (*J. Biomed. Opt.* 31(3):036006), carried forward unchanged.

**One item recurred in search today that is worth an explicit "not new" note:** the **Tran et al. "Dual-Camera High-Resolution Hyperspectral Imaging System for the Retina"** preprint (fei-lab.org host, PDF stamped 2026/02; reported arteriole sO₂ ≈ 96.2 %, venule sO₂ ≈ 76.3 %) resurfaced in today's index results. **This is the same body of work already catalogued in the corpus (scan 08-03 §, and the journal-grade successor at scan 08-13 §2.5)** — the dual-camera snapshot-HSI + RGB-pansharpening design is the group's own earlier/companion embodiment of the *J. Biomed. Opt.* 31(3):036006 system. **Not a new entry; noted here only to record that it was re-seen and de-duplicated.** *fei-lab.org PDF egress-blocked today; content matched against the two prior corpus entries, not re-read.*

**No new venous-specific systemic (SvO₂/ScvO₂) measurement paper today — the sixteenth consecutive scan cycle with none.** All standing Topic-1 anchors and the deep-vein PA anchors are unchanged and carried forward with scores held.
...
- **Metadata flag:** Title/authors/venue/DOI re-confirmed via De Gruyter + ResearchGate snippets today; De Gruyter full text 403 to direct fetch.
...
- **Metadata flag:** DOI/PMC re-confirmed via BMC + Springer snippets today; full text reachable historically, not re-read today.
...
- **Integration insight:** The device most directly bridging Topic-1's clinical need and Topic-2's optical physics on the systemic-venous front; validation-cohort agreement is the key open question for the whole jugular-NIRS class.
- **Metadata flag:** PMID/DOI re-confirmed via ScienceDirect + JCVA snippets today; full text 403 to direct fetch.
...
- **Link / DOI:** company / regulatory record (noninvasix.com); underlying method rooted in the superior-sagittal-sinus / transfontanelle optoacoustic oximetry lineage (*Sci. Rep.* 2022, s41598-022-19350-x)
...
- **Novelty:** Laser-optoacoustic probe worn on the chest reads oxygenation from a named central vein directly, rather than through a tissue-StO₂ surrogate — the device-development counterpart to the IJV-PA research anchor §2.1.
...
- **Metadata flag:** Regulatory/company record, not a peer-reviewed dated paper; treat designation year as reported. Company page re-seen in today's index results; no new filing or dated publication seen today.
...
- **Metadata flag:** Confirmed again today via Wiley Advanced Science DOI + search snippets; full text 403 to direct fetch.
...
- **Link / DOI:** https://doi.org/10.1038/s43856-023-00288-8 · PMC10126115 · https://pubmed.ncbi.nlm.nih.gov/37095177/
...
- **Metadata flag:** DOI/PMID/PMC re-confirmed via Nature *Commun. Med.* + PubMed snippets today; full text 403 to direct fetch.
...
- **Authors:** Tran M.H. (Ling/Martin Tran), Pruitt K., Bryarly M., Emordi I., Ali A., Ma L., Fei B. (Quantitative Bioimaging Laboratory, UT Dallas / UT Southwestern)
...
- **Metadata flag:** Title, authors, venue, volume/issue/article-number and DOI cross-confirmed across ≥2 independent index snippets (SPIE Digital Library listing + PMC + UT Southwestern Pure). **Full text not read** — spiedigitallibrary.org, pmc.ncbi.nlm.nih.gov, and fei-lab.org / UTSW-Pure were egress-blocked to direct fetch today; numeric performance figures are snippet-level and should be treated as reported-not-verified. **Note:** the group's own **"Dual-Camera High-Resolution HSI System for the Retina"** preprint (fei-lab.org, 2026/02; arteriole ≈96.2 % / venule ≈76.3 %) is the earlier/companion embodiment of this system and is **already de-duplicated into this entry** (see day summary) — not a separate paper.
...
- **Quantitative Oximetry with PACT: Principles, Progress, and Prospects** — *J. Innov. Opt. Health Sci.*, 2026 (DOI 10.1142/S1793545826300065; worldscientific.com). Dedicated review of quantitative PACT sO₂ and the fluence/spectral-coloring bottleneck (photon-transport modeling, acoustic-spectrum self-calibration, multimodality fusion, statistical inference, learning-based correction). Review-level scaffold under the deep-vein PA anchors (§2.1/§2.2). Not venous-specific → standing lead. *Author list unverified (publisher 403); title/venue/DOI/year cross-confirmed across two World Scientific + index snippets.*
- **Retinal Oximetry: New Insights into Ocular and Systemic Diseases** — Zhang W., Tu X., Wang X., et al. · *Graefe's Archive for Clinical and Experimental Ophthalmology* 263:2101–2115 (2025) · DOI 10.1007/s00417-025-06831-8 · PMID 40254630 · PMC12414079. Review consolidating retinal oximetry across spectrophotometric-fundus, hyperspectral, and vis-OCT modalities; frames retinal artery *and vein* saturation as ocular + systemic biomarkers. Review-level companion to §2.4/§2.5.
- **Hyperspectral retinal imaging biomarkers of ocular and systemic diseases** — *Eye* (Nature), 2024 · s41433-024-03135-9. Review-level HSI-retina context; frames per-vessel (incl. venular) oximetry as a systemic biomarker. Companion to §2.5.
- **ISDC — Integrated Spectral and Depth Compensation for PA sO₂/THb** — *J. Biomed. Opt.* 31(2):026002 (Feb 2026; DOI 10.1117/1.JBO.31.2.026002; PMC12869027). Depth+spectral fluence correction for deep-tissue PAT sO₂; **not venous-specific** (arterial+venous tissue). Method lead for the deep-vein decoloring problem (§2.2). Snippet-verified only.
- **Near-infrared spectroscopy — reproducible resting skeletal-muscle oxygenation across anatomical sites in stable heart failure** — *Am. J. Physiol. Heart Circ. Physiol.* (2026); DOI 10.1152/ajpheart.00398.2026. **Tissue-level StO₂ (mixed arterial+venous), NOT venous.** Fresh 2026 StO₂-reproducibility baseline for the wearable/tissue-oximetry device class (§1.3/§1.4). *journals.physiology.org egress-blocked; snippet-verified only — reported-not-verified.*
- **Comparative assessment of healthy tissue oxygenation (NIR imaging vs TcPO₂ vs plethysmography)** — El Masry et al. · *Scientific Reports* 15:30424 (2025) · PMID 40830190 · PMC12365204 · DOI 10.1038/s41598-025-15767-2. **Tissue-level (StO₂), NOT venous.** SFDI uniquely detected significant StO₂ differences; device-to-device correlations only moderate-to-fair — a sobering cross-modality-agreement baseline for the wearable-venous device class (§1.3/§1.4).
...
- **Score-based diffusion models for diffuse optical tomography with uncertainty quantification** — Schneider F., Mozumder M., et al. · arXiv:2602.03449 (2026-02-03). Diffusion-model posterior sampling for linearized DOT with calibrated uncertainty — the inverse problem underneath every transcutaneous-NIRS/DOT venous method (§1.2, §1.5). Method lead.
- **Novel Differential Pathlength Factor (DPF) model for NIR diffuse optical imaging** — arXiv:2602.00283 (2026-01-30). Monte-Carlo-derived distance/property-dependent DPF models reducing modified-Beer-Lambert error at small source–detector separations; underpins every transcutaneous-NIRS venous method (§1.2, §1.5). Standing lead.
...
- **Near-Infrared Spiroximetry** (respiration-frequency-filtered NIRS venous saturation; Franceschini/Fantini lineage; PMC3786737). Foundational method for isolating the venous component by respiratory modulation — the physiological root of the "filter at the respiration frequency" strategy shared by §1.2/§1.3 and cerebral-venous DOS. Standing method lead.
- **Noninvasive optical quantification of cerebral venous oxygen saturation in humans** (respiration-modulated DOS; PMID 24439329). Foundational cerebral-venous DOS demonstration; conceptual sibling of spiroximetry. Standing method lead.
...
- **ClinicalTrials.gov standing clinical-reference leads** — NCT06632197 (capnodynamic non-invasive mixed-venous SvO₂ in adults, non-optical reference); NCT04778150 / NCT04624009 (NIRS SjvO₂ in liver-transplant / critically-ill patients); NCT05566626 (Mantis Photonics hyperspectral retinal-oximetry trial). No status change seen today.

---

## Cross-topic synthesis

Today's one-day sweep (08-15 → 08-16) produced **no new intravascular venous optical result** for either topic, and **nothing genuinely new to the corpus at all** — the one paper that stood out in search results (the Tran/Fei "dual-camera" hyperspectral retina system) is the group's own earlier embodiment of the already-catalogued *J. Biomed. Opt.* 31(3):036006 system, so it is de-duplicated rather than added. **No new systemic SvO₂/ScvO₂ measurement paper appeared — the sixteenth consecutive dry cycle** for true central/peripheral venous work once arterial-only and tissue-level items are excluded. The most recent genuinely-new venous result in the corpus remains the 08-13 Tran et al. hyperspectral retinal imager (§2.5), in the **retinal per-vessel venular** sub-cluster.
...
*Scan generated 2026-08-16 (UTC). Metadata cross-checked across ≥2 search-index snippets per item; arxiv.org, pmc.ncbi.nlm.nih.gov, www.spiedigitallibrary.org, and fei-lab.org were egress-blocked, and publisher full-text pages (Optica, Wiley, ScienceDirect, Springer, De Gruyter) returned HTTP 403 to direct fetch in this environment (source-/policy-side; agent proxy healthy), so items flagged "full text not read" / "snippet-verified" are abstract- or snippet-level and flagged unverified fields are noted inline.*
