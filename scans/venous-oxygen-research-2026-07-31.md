# Venous Oxygen Research Scan — 2026-07-31

**Search window:** Twenty-ninth scan in the series, run **three days** after 2026-07-28 (no scans on 07-29, 07-30). Emphasis on work published or first-surfacing after 07-28, with the standard fallback to the best-available venous-specific work already catalogued. Sources swept today: PubMed/PMC, arXiv (incl. physics.med-ph new-listing sweep), bioRxiv/medRxiv, Optica (Biomed. Opt. Express, Optics Letters, Applied Optics), SPIE / *J. Biomed. Opt.*, *Photoacoustics* (ScienceDirect), IEEE Xplore, Nature / *Sci. Rep.* / *Commun. Med.*, Wiley (*Advanced Science*, *J. Biophotonics*), Springer, De Gruyter, MDPI (*Biosensors*), *CHEST* / ScienceDirect, ClinicalTrials.gov, ResearchGate, Semantic Scholar, ADS.

**Verification caveat:** As in every prior scan, publisher **full-text** pages — including spiedigitallibrary.org, pmc.ncbi.nlm.nih.gov, arxiv.org, opg.optica.org, advanced.onlinelibrary.wiley.com, sciencedirect.com, the Nature domains and biorxiv/medrxiv — returned **HTTP 403** to direct `WebFetch` in this environment today (fei-lab.org and science.gov topic pages likewise 403). Every reference below was therefore cross-checked across **at least two independent search-index snippets** (Google Scholar–style result blocks + SPIE Digital Library / PMC / ADS / ResearchGate / Optica listings); per-item notes state what was confirmed and what could not be read directly on a publisher page.

---

## ⚠️ Read this first — day summary

**No new venous-specific *primary* measurement paper today — the eighth consecutive scan cycle with none.** Consistent with the series' standing observation, truly novel non-invasive **venous**-optical work publishes at very low volume, and today's three-day sweep produced **no new SvO₂/ScvO₂ demonstration**. The Topic-1 (true SvO₂) top-5 is unchanged and carried forward with scores held.

Today did, however, surface **one genuinely new-to-corpus optical-oximetry item** on the imaging side (Topic 2):

- **★ NEW — Tran, Pruitt, Bryarly, Emordi, Ali, Ma & Fei, "Development and validation of a high-resolution hyperspectral imaging system for the retina," *J. Biomed. Opt.* 31(3):036006, March 2026** (DOI 10.1117/1.JBO.31.3.036006; PMC12997856). A validated dual-camera (snapshot-hyperspectral + high-res RGB, deep-learning pansharpened) retinal HSI system that extracts **per-vessel diameter and oxygen saturation simultaneously** — i.e. resolves retinal **vein** vs artery sO₂ at 0.1 mm/pixel. This is the journal-grade, validated successor to the SPIE-conference hyperspectral items previously logged from the same lab (Fei / Quantitative Bioimaging Laboratory, UT Southwestern). It **enters the Topic-2 top-5** (§2.3), displacing the sulfate-phantom metrology paper down to standing leads. Retinal/per-vessel — not systemic SvO₂ — so scored accordingly.

Plus two **new-to-corpus technique leads** (not venous measurements, logged under standing context):

- **★ NEW lead — Schneider, Mozumder, Tamarov, Taghizadeh, Tarvainen, Helin & Duong, "Score-based diffusion models for diffuse optical tomography with uncertainty quantification," arXiv:2602.03449 (submitted 2026-02-03).** Diffusion-model posterior sampling for the ill-posed DOT inverse problem **with UQ** — directly relevant to the fluence/ill-posedness bottleneck underneath every transcutaneous-NIRS/DOT venous method.
- **★ NEW lead — "Deep Learning From Diffuse Optical Oximetry Time-Series: An fNIRS-Focused Review," *IEEE* (2025/2026; doc. 11230578).** Review of DL on diffuse-optical oximetry time-series; tissue-level/fNIRS, not venous, but scaffolds the temporal-ML side of the program.

Everything else returned today is **previously surfaced** or out-of-scope: the IJV-PA anchor (arXiv:2303.10775), APM+ radial-vein PA oximetry (Sastry/Olick-Gibson et al., *Adv. Sci.* 2026, 10.1002/advs.76366), the Alqahtani jugular optical sensor (De Gruyter CDBME 2024), the IJV DNN + Monte-Carlo work (*Optics Letters* 49(10):2669), the ADS-vis-OCT retinal oximetry paper (*Commun. Med.* 2023), PACT intravascular oxygenation/flow (PMC11161372), the sulfate blood-phantom metrology paper (arXiv:2512.01458 / *Appl. Opt.* 65(6):1974), Mespere VO100 jugular NIRS, the McDiarmid MRI iSvO₂ model, the SSL intra-cardiac MR oximetry preprint, Hybrid-Net (arXiv:2512.15394), the distribution-informed data-driven oximetry preprint (arXiv:2403.14863), ISDC, the Gokhale *CHEST* review, and the Zheng dynamic-PA pulsation review. **No new primary venous demonstration.**
...
- **Integration insights:** The inverse-modeling / fluence-correction leg of the program; the physics-simulation twin of the self-supervised-learning approach in §1.3. Its accuracy is bounded by the pathlength/fluence assumptions the DPF-model preprint (standing lead) reformulates, and the new score-based-diffusion DOT preprint (standing lead) is a direct methodological competitor for the same inverse problem *with* uncertainty. *Cross-confirmed via Optica listing + Semantic Scholar again today; full text 403 (flagged).*
...
- **Integration insights:** The label-scarce SSL + uncertainty recipe is **directly portable** to the optical side, where labelled in-vivo SvO₂ ground truth is the binding constraint (cf. §1.2). Value as a cross-modality **validation target** and transferable ML methodology; its UQ framing now rhymes with the new DOT diffusion-model preprint (standing lead) on the optical side. *Metadata confirmed across two search snippets; abstract not readable (medRxiv 403).*
...
*One new-to-corpus item this cycle (§2.3, hyperspectral retinal HSI).* The rest of the standing set carried forward with scores held; the sulfate-phantom metrology paper moves down to standing leads to make room.
...
### 2.3 — ★ NEW — Development and Validation of a High-Resolution Hyperspectral Imaging System for the Retina *(new-to-corpus; per-vessel retinal artery/vein sO₂)*
...
- **Novelty:** A compact dual-camera design — a **snapshot hyperspectral camera** (fast, low native spatial resolution ~0.2 mm/pixel) fused with a **high-resolution RGB camera** via **deep-learning pansharpening** — produces high-resolution hyperspectral retinal images (~0.1 mm/pixel, a 2× spatial-resolution gain) from which **retinal vessel diameter and oxygen saturation are extracted simultaneously**. The journal-grade, *validated* successor to the group's earlier SPIE-conference hyperspectral retinal/whole-blood items previously logged only as unverified SPIE leads.
...
- **★ NEW this cycle — Schneider F., Mozumder M., Tamarov K., Taghizadeh L., Tarvainen T., Helin T., Duong D.-L., "Score-based diffusion models for diffuse optical tomography with uncertainty quantification," arXiv:2602.03449 (submitted 2026-02-03).** Diffusion-model posterior sampling (UCoS framework) for linearized difference-imaging DOT, delivering state-of-the-art reconstructions on this severely ill-posed inverse problem **with calibrated uncertainty**. Not a venous measurement, but the DOT inverse problem it solves is the one underneath every transcutaneous-NIRS/DOT venous method (§1.2, §1.5); its UQ is the optical-side echo of the SSL/UQ MRI work (§1.3). Well-known Kuopio/LUT DOT-optics group. *Title, authors, submission date, abstract cross-confirmed via arXiv listing + search snippet; full text 403 (flagged).*
- **★ NEW lead this cycle — "Deep Learning From Diffuse Optical Oximetry Time-Series: An fNIRS-Focused Review," *IEEE* (2025/2026; document 11230578).** Review of deep-learning methods applied to diffuse-optical oximetry *time-series*; fNIRS/tissue-level, not venous, but scaffolds the temporal-ML machinery (continuous tracking, artifact rejection) that any continuous optical SvO₂ monitor will need. *Title/venue from IEEE Xplore listing; full text not read (flagged).*
- **Sulfate Phantoms to Mimic NIR Photoacoustic Response of Whole Blood at Selected Oxygen Saturations** — Davenet et al. (Sorbonne Université), 2026 · *Applied Optics* 65(6):1974 (also arXiv:2512.01458). *(Was Topic-2 §2.5 through 07-28; moved here to admit the new HSI paper — metrology, not a venous measurement.)* Inorganic sulfate solutions reproduce both the optical absorption *and* the Grüneisen coefficient of whole blood at chosen sO₂ over 700–850 nm — a ground-truth phantom for validating deep-vein PA oximetry across the venous ≈40–75 % range that arterially-tuned phantoms handle poorly. Complements the Fei-lab anthropomorphic oximetry phantoms (arXiv:2503.23161). Standing metrology lead. *Cross-confirmed via arXiv + Optica listing; full text 403 (flagged).*
...
**1. Eighth consecutive cycle with no new venous *primary* measurement — but the imaging side moved for the first time in weeks.** Today's three-day sweep again produced **no new systemic-SvO₂/ScvO₂ demonstration** (Topic 1 unchanged), confirming the standing read that truly novel non-invasive venous-optical *measurement* publishes quarterly at best. What *did* move is Topic 2's **retinal per-vessel** leg: a validated, journal-grade snapshot-hyperspectral retinal oximetry system (§2.3, Tran/Fei, *JBO* March 2026) enters the top-5. It is not systemic SvO₂ — but it is a genuine, new, non-invasive optical measurement of **retinal vein** saturation, and it upgrades a line the corpus previously held only as unverified SPIE-conference leads.

**2. The retina is now covered by two complementary optical modalities.** With the new HSI system (§2.3) alongside ADS-vis-OCT (§2.4), the one site where per-vessel optical **venous** saturation is routinely achievable is now bracketed by a **wide-field snapshot** route (hyperspectral + pansharpening) and a **depth-resolved single-vessel** route (vis-OCT). The transferable lesson for the deep-vein program is the same one APM+ (§2.2) teaches: exploit the artery/vein pairing as an internal reference, and buy resolution through sensor fusion rather than more wavelengths.

**3. Two independent human demonstrations still bracket the *systemic* problem, and both are photoacoustic.** The IJV-PA anchor (§2.1, deep central vein, US-co-registered) and APM+ (§2.2, peripheral radial vein, artery-calibrated) remain the only two in-vivo human non-invasive *optical* venous-sO₂ results in the corpus, converging on ~72 % by opposite routes. Everything else true-venous is non-optical (MRI iSvO₂ §1.4, SSL intra-cardiac MR §1.3) or shallow/peripheral device work (Alqahtani EJV §1.1, pulse-modulation §1.5). The *systemic* optical-venous field still rests on two papers.

**4. Fluence + ill-posedness + uncertainty is the universal bottleneck, and the tooling is converging.** Today added a new lever: **score-based diffusion models with UQ for the DOT inverse problem** (Schneider/Tarvainen, standing lead) — a Bayesian, uncertainty-aware attack on the same ill-posed reconstruction underneath every transcutaneous-NIRS/DOT venous method. It joins APM+ (artery-as-calibrator), ISDC (depth+spectral compensation), APRECOT (anatomical priors), the DPF model (pathlength), Hybrid-Net (fluence-free DL) and the sulfate/anthropomorphic phantoms (ground-truth validation). The recurring theme across modalities in 2026 is **uncertainty quantification** — MRI (§1.3) and DOT (new) both now ship calibrated error bars, which is exactly what a clinical SvO₂ device needs and what the PA anchors (§2.1/§2.2) still largely lack.

**5. Venous sO₂ is a field, not a scalar — and label scarcity still couples the modalities.** The PACT flow/heterogeneity work (§2.5) plus the dynamic-PA pulsation review (standing) keep reframing the target as saturation × flow = oxygen flux. The binding constraint remains **labelled in-vivo SvO₂ ground truth**, which is why the MRI/ML entries (§1.3, §1.4) matter to the optical program as transferable methodology and validation targets, and why the new fNIRS DL-time-series review (standing lead) is worth tracking for the continuous-monitoring machinery. Open gaps carried forward, all still open: (a) no continuous, calibrated, wearable optical SvO₂ device validated against blood-gas with published limits-of-agreement; (b) no quantitative deep-venous PA sO₂ with an in-situ fluence reference across multiple deep sites and the full venous 40–75 % range; (c) no non-invasive optical/PA SvO₂ method benchmarked head-to-head against reference CMR oximetry. Today closed none of these; it strengthened the retinal-oximetry and inverse-problem tooling that surround them.

---

*Scan generated 2026-07-31 (UTC). No new venous-specific **primary systemic** SvO₂/ScvO₂ measurement (eighth consecutive cycle); Topic-1 top-5 carried forward with scores held. **One new-to-corpus optical item** promoted into the Topic-2 top-5 — Tran, Pruitt, Bryarly, Emordi, Ali, Ma & Fei, "Development and validation of a high-resolution hyperspectral imaging system for the retina," *J. Biomed. Opt.* 31(3):036006, March 2026 (per-vessel retinal artery/vein sO₂) — displacing the sulfate-phantom metrology paper to standing leads. Two new-to-corpus technique leads logged: score-based-diffusion DOT with UQ (arXiv:2602.03449) and an fNIRS DL-oximetry review (IEEE 11230578). Publisher full-text access was 403-blocked throughout this environment; every reference was cross-checked across ≥2 independent search-index snippets, with per-item verification notes and flags above.*
